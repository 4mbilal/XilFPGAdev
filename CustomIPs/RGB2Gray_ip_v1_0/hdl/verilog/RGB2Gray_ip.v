// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\RGB2GrayIP\RGB2Gray_ip.v
// Created: 2021-04-13 00:50:23
// 
...
module RGB2Gray_ip
  ...
  assign ip_timestamp = 32'b01111101011010100111101000000010;
  ...
  RGB2Gray_ip_reset_sync u_RGB2Gray_ip_reset_sync_inst (.clk(IPCORE_CLK),  // ufix1
                                                        .reset_in(reset_before_sync),  // ufix1
                                                        .reset_out(reset)
                                                        );

  RGB2Gray_ip_axi_lite u_RGB2Gray_ip_axi_lite_inst (.reset(reset),
  ...
  RGB2Gray_ip_axi4_stream_video_slave u_RGB2Gray_ip_axi4_stream_video_slave_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                  .reset(reset),
                                                                                  .enb(const_1),
  ...
  RGB2Gray_ip_dut u_RGB2Gray_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                          .reset(reset),
  ...
  RGB2Gray_ip_axi4_stream_video_master u_RGB2Gray_ip_axi4_stream_video_master_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                    .reset(reset),
                                                                                    .enb(const_1),
