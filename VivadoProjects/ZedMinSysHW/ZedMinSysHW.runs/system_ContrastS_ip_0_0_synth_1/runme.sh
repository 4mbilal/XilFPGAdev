...
HD_PWD='D:/Work/XilFPGAdev/VivadoProjects/ZedMinSysHW/ZedMinSysHW.runs/system_ContrastS_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ContrastS_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ContrastS_ip_0_0.tcl
