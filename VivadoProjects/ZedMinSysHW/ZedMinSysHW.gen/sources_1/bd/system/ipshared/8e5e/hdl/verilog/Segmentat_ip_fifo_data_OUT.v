// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: Segmentat_ip_fifo_data_OUT
// Source Path: Segmentat_ip/Segmentat_ip_axi4_stream_video_master/Segmentat_ip_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Segmentat_ip_fifo_data_OUT
  ...
  Segmentat_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                           .DataWidth(32)
                                           )
                                         u_Segmentat_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                           .enb(enb),
                                                                                           .wr_din(In),
                                                                                           .wr_addr(w_waddr),
                                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // Segmentat_ip_fifo_data_OUT
