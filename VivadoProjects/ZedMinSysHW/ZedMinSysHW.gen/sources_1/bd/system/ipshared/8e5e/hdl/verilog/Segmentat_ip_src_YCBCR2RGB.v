// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip_src_YCBCR2RGB.v
...
// -------------------------------------------------------------
// 
// Module: Segmentat_ip_src_YCBCR2RGB
// Source Path: Sementation_4K_480p/Segmentation_HW/K-Means/Color Space Converter1/YCBCR2RGB
// Hierarchy Level: 3
// 
...
module Segmentat_ip_src_YCBCR2RGB
  ...
  Segmentat_ip_src_YCbCr2RGBCore u_ycbcr2rgbCore_inst (.clk(clk),
                                                       .reset(reset),
                                                       .enb(enb),
                                                       .Y(In1Reg),  // uint8
                                                       .Cb(In2Reg),  // uint8
...
endmodule  // Segmentat_ip_src_YCBCR2RGB
