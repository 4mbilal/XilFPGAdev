-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DisparityV0_ip_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DisparityV0_ip_fifo_data
-- Source Path: DisparityV0_ip/DisparityV0_ip_axi4_stream_video_slave/DisparityV0_ip_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DisparityV0_ip_fifo_data IS
...
END DisparityV0_ip_fifo_data;


ARCHITECTURE rtl OF DisparityV0_ip_fifo_data IS
...
BEGIN
  ...
  u_DisparityV0_ip_fifo_data_classic_ram : DisparityV0_ip_SimpleDualPortRAM_generic
