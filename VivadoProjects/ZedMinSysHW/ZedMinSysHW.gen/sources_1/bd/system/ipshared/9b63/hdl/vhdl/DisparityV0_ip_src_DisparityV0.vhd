-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DisparityV0_ip_src_DisparityV0.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DisparityV0_ip_src_DisparityV0
...
ENTITY DisparityV0_ip_src_DisparityV0 IS
...
END DisparityV0_ip_src_DisparityV0;


ARCHITECTURE rtl OF DisparityV0_ip_src_DisparityV0 IS

  -- Component Declarations
  COMPONENT DisparityV0_ip_src_ct
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DisparityV0_ip_src_ct
    USE ENTITY work.DisparityV0_ip_src_ct(rtl);
