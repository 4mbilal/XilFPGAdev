-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DIPfilte_ip_fifo_data
-- Source Path: DIPfilte_ip/DIPfilte_ip_axi4_stream_video_slave/DIPfilte_ip_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DIPfilte_ip_fifo_data IS
...
END DIPfilte_ip_fifo_data;


ARCHITECTURE rtl OF DIPfilte_ip_fifo_data IS
...
BEGIN
  ...
  u_DIPfilte_ip_fifo_data_classic_ram : DIPfilte_ip_SimpleDualPortRAM_generic
