-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DIPfilte_ip_fifo_data_OUT
-- Source Path: DIPfilte_ip/DIPfilte_ip_axi4_stream_video_master/DIPfilte_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DIPfilte_ip_fifo_data_OUT IS
...
END DIPfilte_ip_fifo_data_OUT;


ARCHITECTURE rtl OF DIPfilte_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT DIPfilte_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : DIPfilte_ip_SimpleDualPortRAM_generic
    USE ENTITY work.DIPfilte_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_DIPfilte_ip_fifo_data_OUT_classic_ram_generic : DIPfilte_ip_SimpleDualPortRAM_generic
