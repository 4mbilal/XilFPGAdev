-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_adapter_in.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DIPfilte_ip_adapter_in
-- Source Path: DIPfilte_ip/DIPfilte_ip_axi4_stream_video_slave/DIPfilte_ip_adapter_in
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DIPfilte_ip_adapter_in IS
...
END DIPfilte_ip_adapter_in;


ARCHITECTURE rtl OF DIPfilte_ip_adapter_in IS

  -- Component Declarations
  COMPONENT DIPfilte_ip_adapter_in_module
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DIPfilte_ip_adapter_in_module
    USE ENTITY work.DIPfilte_ip_adapter_in_module(rtl);

  -- Signals
  SIGNAL user_pixel_tmp                   : std_logic_vector(31 DOWNTO 0);  -- ufix32

BEGIN
  u_DIPfilte_ip_DIPfilte_ip_axi4_stream_video_slave_DIPfilte_ip_adapter_in_DIPfilte_ip_adapter_in_module : DIPfilte_ip_adapter_in_module
    PORT MAP( clk => clk,
              reset => reset,
