-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_fifo_sof.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DIPfilte_ip_fifo_sof
-- Source Path: DIPfilte_ip/DIPfilte_ip_axi4_stream_video_slave/DIPfilte_ip_fifo_sof
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DIPfilte_ip_fifo_sof IS
...
END DIPfilte_ip_fifo_sof;


ARCHITECTURE rtl OF DIPfilte_ip_fifo_sof IS
...
BEGIN
  ...
  u_DIPfilte_ip_fifo_sof_classic_ram : DIPfilte_ip_SimpleDualPortRAM_singlebit
