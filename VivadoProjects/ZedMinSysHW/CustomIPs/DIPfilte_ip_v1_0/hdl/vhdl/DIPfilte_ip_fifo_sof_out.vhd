-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_fifo_sof_out.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DIPfilte_ip_fifo_sof_out
-- Source Path: DIPfilte_ip/DIPfilte_ip_axi4_stream_video_master/DIPfilte_ip_fifo_sof_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DIPfilte_ip_fifo_sof_out IS
...
END DIPfilte_ip_fifo_sof_out;


ARCHITECTURE rtl OF DIPfilte_ip_fifo_sof_out IS

  -- Component Declarations
  COMPONENT DIPfilte_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : DIPfilte_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.DIPfilte_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_DIPfilte_ip_fifo_sof_out_classic_ram_singlebit : DIPfilte_ip_SimpleDualPortRAM_singlebit
