-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_axi4_stream_video_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DIPfilte_ip_axi4_stream_video_slave
-- Source Path: DIPfilte_ip/DIPfilte_ip_axi4_stream_video_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DIPfilte_ip_axi4_stream_video_slave IS
...
END DIPfilte_ip_axi4_stream_video_slave;


ARCHITECTURE rtl OF DIPfilte_ip_axi4_stream_video_slave IS

  -- Component Declarations
  COMPONENT DIPfilte_ip_fifo_eol
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DIPfilte_ip_fifo_sof
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT DIPfilte_ip_adapter_in
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT DIPfilte_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DIPfilte_ip_fifo_eol
    USE ENTITY work.DIPfilte_ip_fifo_eol(rtl);

  FOR ALL : DIPfilte_ip_fifo_sof
    USE ENTITY work.DIPfilte_ip_fifo_sof(rtl);

  FOR ALL : DIPfilte_ip_adapter_in
    USE ENTITY work.DIPfilte_ip_adapter_in(rtl);

  FOR ALL : DIPfilte_ip_fifo_data
    USE ENTITY work.DIPfilte_ip_fifo_data(rtl);
...
BEGIN
  u_DIPfilte_ip_fifo_eol_inst : DIPfilte_ip_fifo_eol
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_DIPfilte_ip_fifo_sof_inst : DIPfilte_ip_fifo_sof
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_DIPfilte_ip_DIPfilte_ip_axi4_stream_video_slave_DIPfilte_ip_adapter_in : DIPfilte_ip_adapter_in
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_DIPfilte_ip_fifo_data_inst : DIPfilte_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
