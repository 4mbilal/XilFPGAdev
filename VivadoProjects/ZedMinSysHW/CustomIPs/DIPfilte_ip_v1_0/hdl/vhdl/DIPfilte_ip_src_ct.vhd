-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_src_ct.vhd
...
USE work.DIPfilte_ip_src_DisparityV0_pkg.ALL;

ENTITY DIPfilte_ip_src_ct IS
...
END DIPfilte_ip_src_ct;


ARCHITECTURE rtl OF DIPfilte_ip_src_ct IS

  -- Component Declarations
  COMPONENT DIPfilte_ip_src_LB_D
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DIPfilte_ip_src_LB_D1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  COMPONENT DIPfilte_ip_src_LB_D2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  COMPONENT DIPfilte_ip_src_LB_D3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  COMPONENT DIPfilte_ip_src_LB_D4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  COMPONENT DIPfilte_ip_src_LB_D5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(7 DOWNTO 0);  -- uint8
  ...
  FOR ALL : DIPfilte_ip_src_LB_D
    USE ENTITY work.DIPfilte_ip_src_LB_D(rtl);

  FOR ALL : DIPfilte_ip_src_LB_D1
    USE ENTITY work.DIPfilte_ip_src_LB_D1(rtl);

  FOR ALL : DIPfilte_ip_src_LB_D2
    USE ENTITY work.DIPfilte_ip_src_LB_D2(rtl);

  FOR ALL : DIPfilte_ip_src_LB_D3
    USE ENTITY work.DIPfilte_ip_src_LB_D3(rtl);

  FOR ALL : DIPfilte_ip_src_LB_D4
    USE ENTITY work.DIPfilte_ip_src_LB_D4(rtl);

  FOR ALL : DIPfilte_ip_src_LB_D5
    USE ENTITY work.DIPfilte_ip_src_LB_D5(rtl);
