-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_fifo_eol.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DIPfilte_ip_fifo_eol
-- Source Path: DIPfilte_ip/DIPfilte_ip_axi4_stream_video_slave/DIPfilte_ip_fifo_eol
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DIPfilte_ip_fifo_eol IS
...
END DIPfilte_ip_fifo_eol;


ARCHITECTURE rtl OF DIPfilte_ip_fifo_eol IS
...
BEGIN
  ...
  u_DIPfilte_ip_fifo_eol_classic_ram : DIPfilte_ip_SimpleDualPortRAM_singlebit
