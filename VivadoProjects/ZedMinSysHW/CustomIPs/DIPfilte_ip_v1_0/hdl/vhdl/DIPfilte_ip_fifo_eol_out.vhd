-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DIPfilte_ip_fifo_eol_out.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DIPfilte_ip_fifo_eol_out
-- Source Path: DIPfilte_ip/DIPfilte_ip_axi4_stream_video_master/DIPfilte_ip_fifo_eol_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DIPfilte_ip_fifo_eol_out IS
...
END DIPfilte_ip_fifo_eol_out;


ARCHITECTURE rtl OF DIPfilte_ip_fifo_eol_out IS
...
BEGIN
  ...
  u_DIPfilte_ip_fifo_eol_out_classic_ram : DIPfilte_ip_SimpleDualPortRAM_singlebit
