// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_axi4_stream_video_slave.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_axi4_stream_video_slave
// Source Path: SGBMHDLAl_ip/SGBMHDLAl_ip_axi4_stream_video_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_axi4_stream_video_slave
  ...
  SGBMHDLAl_ip_fifo_eol u_SGBMHDLAl_ip_fifo_eol_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  SGBMHDLAl_ip_fifo_sof u_SGBMHDLAl_ip_fifo_sof_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  SGBMHDLAl_ip_adapter_in u_SGBMHDLAl_ip_SGBMHDLAl_ip_axi4_stream_video_slave_SGBMHDLAl_ip_adapter_in (.clk(clk),
                                                                                                       .reset(reset),
  ...
  SGBMHDLAl_ip_fifo_data u_SGBMHDLAl_ip_fifo_data_inst (.clk(clk),
                                                        .reset(reset),
                                                        .enb(enb),
...
endmodule  // SGBMHDLAl_ip_axi4_stream_video_slave
