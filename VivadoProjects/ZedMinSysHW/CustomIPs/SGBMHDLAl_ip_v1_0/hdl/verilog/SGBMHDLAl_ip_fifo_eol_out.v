// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_fifo_eol_out.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_fifo_eol_out
// Source Path: SGBMHDLAl_ip/SGBMHDLAl_ip_axi4_stream_video_master/SGBMHDLAl_ip_fifo_eol_out
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_fifo_eol_out
  ...
  SGBMHDLAl_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                           ...
                                           u_SGBMHDLAl_ip_fifo_eol_out_classic_ram (.clk(clk),
                                                                                    .enb(enb),
                                                                                    .wr_din(In),  // ufix1
                                                                                    .wr_addr(w_waddr),
                                                                                    .wr_en(w_we),  // ufix1
...
endmodule  // SGBMHDLAl_ip_fifo_eol_out
