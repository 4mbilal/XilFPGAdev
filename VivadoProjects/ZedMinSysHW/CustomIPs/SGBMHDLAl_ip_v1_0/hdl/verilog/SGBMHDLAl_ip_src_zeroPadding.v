// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_src_zeroPadding.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_src_zeroPadding
// Source Path: SGBMDisparity/SGBMHDLAlgorithm/SGBMHDLAlgorithmWorker/MatchingCost/CensusTransform/zeroPadding
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_src_zeroPadding
  ...
  SGBMHDLAl_ip_src_FIFO u_FIFO (.clk(clk),
                                .reset(reset),
                                .enb(enb),
  ...
  SGBMHDLAl_ip_src_popSubsystem u_popSubsystem (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .enable(CC5_out1),
...
endmodule  // SGBMHDLAl_ip_src_zeroPadding
