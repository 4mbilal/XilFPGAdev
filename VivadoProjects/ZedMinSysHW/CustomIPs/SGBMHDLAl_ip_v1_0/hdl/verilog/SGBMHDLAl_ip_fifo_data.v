// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_fifo_data.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_fifo_data
// Source Path: SGBMHDLAl_ip/SGBMHDLAl_ip_axi4_stream_video_slave/SGBMHDLAl_ip_fifo_data
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_fifo_data
  ...
  SGBMHDLAl_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                         ...
                                         u_SGBMHDLAl_ip_fifo_data_classic_ram (.clk(clk),
                                                                               .enb(enb),
                                                                               .wr_din(In),
                                                                               .wr_addr(w_waddr),
                                                                               .wr_en(w_we),  // ufix1
...
endmodule  // SGBMHDLAl_ip_fifo_data
