// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_axi4_stream_video_master.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_axi4_stream_video_master
// Source Path: SGBMHDLAl_ip/SGBMHDLAl_ip_axi4_stream_video_master
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_axi4_stream_video_master
  ...
  SGBMHDLAl_ip_fifo_data_OUT u_SGBMHDLAl_ip_fifo_data_OUT_inst (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
  ...
  SGBMHDLAl_ip_fifo_eol_out u_SGBMHDLAl_ip_fifo_eol_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
  ...
  SGBMHDLAl_ip_fifo_sof_out u_SGBMHDLAl_ip_fifo_sof_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
...
endmodule  // SGBMHDLAl_ip_axi4_stream_video_master
