// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_src_inverseRowLeft1.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_src_inverseRowLeft1
// Source Path: SGBMDisparity/SGBMHDLAlgorithm/SGBMHDLAlgorithmWorker/MatchingCost/HammDistRL/inverseRowLeft1
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_src_inverseRowLeft1
  ...
  assign vStart = rightBus_vStart;

  assign hEnd = rightBus_hEnd;
  ...
  assign rightOut = Simple_Dual_Port_RAM_out1;

  assign rightvStart = rightBus_vStart;

endmodule  // SGBMHDLAl_ip_src_inverseRowLeft1
