// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_src_d_2_block1.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_src_d_2_block1
// Source Path: SGBMDisparity/SGBMHDLAlgorithm/SGBMHDLAlgorithmWorker/DirectionalCost/TopRightToBottomLeft/trblSubsystem/d+2
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_src_d_2_block1
  ...
  input   signed [9:0] prev_cost_d_15;  // sfix10
  ...
  assign prev_cost_d_1_0 = prev_cost_d_1;

  assign prev_cost_d_1_1 = prev_cost_d_2;

  assign prev_cost_d_1_2 = prev_cost_d_3;

  assign prev_cost_d_1_3 = prev_cost_d_4;

  assign prev_cost_d_1_4 = prev_cost_d_5;

  assign prev_cost_d_1_5 = prev_cost_d_6;

  assign prev_cost_d_1_6 = prev_cost_d_7;

  assign prev_cost_d_1_7 = prev_cost_d_8;

  assign prev_cost_d_1_8 = prev_cost_d_9;

  assign prev_cost_d_1_9 = prev_cost_d_10;

  assign prev_cost_d_1_10 = prev_cost_d_11;

  assign prev_cost_d_1_11 = prev_cost_d_12;

  assign prev_cost_d_1_12 = prev_cost_d_13;

  assign prev_cost_d_1_13 = prev_cost_d_14;

  assign prev_cost_d_1_14 = prev_cost_d_15;

  assign Constant_out1 = 10'sb0011111111;



  assign prev_cost_d_1_15 = Constant_out1;

endmodule  // SGBMHDLAl_ip_src_d_2_block1
