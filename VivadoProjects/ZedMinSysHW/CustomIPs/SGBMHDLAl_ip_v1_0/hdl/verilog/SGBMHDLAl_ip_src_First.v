// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_src_First.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_src_First
// Source Path: SGBMDisparity/SGBMHDLAlgorithm/SGBMHDLAlgorithmWorker/PostProcessing/Interpolation/Division/QuoRem/First
// Hierarchy Level: 6
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_src_First
  ...
  assign Switch2_out1 = (Extract_Bits5_out1 == 1'b0 ? Bit_Shift_out1 :
              Bit_Concat2_out1);
  ...
  assign Start = Extract_Bits5_out1;

endmodule  // SGBMHDLAl_ip_src_First
