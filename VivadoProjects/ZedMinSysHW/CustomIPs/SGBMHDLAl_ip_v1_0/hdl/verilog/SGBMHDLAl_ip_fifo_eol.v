// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_fifo_eol.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_fifo_eol
// Source Path: SGBMHDLAl_ip/SGBMHDLAl_ip_axi4_stream_video_slave/SGBMHDLAl_ip_fifo_eol
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_fifo_eol
  ...
  SGBMHDLAl_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                           ...
                                           u_SGBMHDLAl_ip_fifo_eol_classic_ram (.clk(clk),
                                                                                .enb(enb),
                                                                                .wr_din(In),  // ufix1
                                                                                .wr_addr(w_waddr),
                                                                                .wr_en(w_we),  // ufix1
...
endmodule  // SGBMHDLAl_ip_fifo_eol
