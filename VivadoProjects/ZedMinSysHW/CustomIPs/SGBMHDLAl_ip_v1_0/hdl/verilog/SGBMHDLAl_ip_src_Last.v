// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_src_Last.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_src_Last
// Source Path: SGBMDisparity/SGBMHDLAlgorithm/SGBMHDLAlgorithmWorker/PostProcessing/Interpolation/Division/QuoRem/Last
// Hierarchy Level: 6
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_src_Last
  ...
  assign Extract_Bits6_out1 = Extract_Bits4_out1[12];



  assign Logical_Operator_out1 = Extract_Bits6_out1 | In3;
  ...
  assign Switch4_out1 = (Logical_Operator_out1 == 1'b0 ? Extract_Bits4_out1 :
              Switch1_out1);



  assign Quo = Switch4_out1;

  assign Div = In2;

  assign Extract_Bits5_out1 = Switch_out1[12];



  assign Add2_out1 = Switch_out1 + In2;



  assign Switch2_out1 = (Extract_Bits5_out1 == 1'b0 ? Switch_out1 :
              Add2_out1);



  assign Switch3_out1 = (Logical_Operator_out1 == 1'b0 ? Extract_Bits3_out1 :
              Switch2_out1);



  assign Rem = Switch3_out1;

endmodule  // SGBMHDLAl_ip_src_Last
