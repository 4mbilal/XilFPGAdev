// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\SGBMDisparity\SGBMHDLAl_ip_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: SGBMHDLAl_ip_fifo_data_OUT
// Source Path: SGBMHDLAl_ip/SGBMHDLAl_ip_axi4_stream_video_master/SGBMHDLAl_ip_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module SGBMHDLAl_ip_fifo_data_OUT
  ...
  SGBMHDLAl_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                           .DataWidth(32)
                                           )
                                         u_SGBMHDLAl_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                           .enb(enb),
                                                                                           .wr_din(In),
                                                                                           .wr_addr(w_waddr),
                                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // SGBMHDLAl_ip_fifo_data_OUT
