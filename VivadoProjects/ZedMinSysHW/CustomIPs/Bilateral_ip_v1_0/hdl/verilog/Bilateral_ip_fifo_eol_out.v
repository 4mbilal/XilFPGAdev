// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BilateralFilterIP\Bilateral_ip_fifo_eol_out.v
...
// -------------------------------------------------------------
// 
// Module: Bilateral_ip_fifo_eol_out
// Source Path: Bilateral_ip/Bilateral_ip_axi4_stream_video_master/Bilateral_ip_fifo_eol_out
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Bilateral_ip_fifo_eol_out
  ...
  Bilateral_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                           ...
                                           u_Bilateral_ip_fifo_eol_out_classic_ram (.clk(clk),
                                                                                    .enb(enb),
                                                                                    .wr_din(In),  // ufix1
                                                                                    .wr_addr(w_waddr),
                                                                                    .wr_en(w_we),  // ufix1
...
endmodule  // Bilateral_ip_fifo_eol_out
