// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BilateralFilterIP\Bilateral_ip_src_LineBuffer.v
...
// -------------------------------------------------------------
// 
// Module: Bilateral_ip_src_LineBuffer
// Source Path: BilateralFilterIP/BilateralFilter_HW/Bilateral Filter1/LineBuffer
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Bilateral_ip_src_LineBuffer
  ...
  output  [7:0] dataOut_3;  // uint8
  output  [7:0] dataOut_4;  // uint8
  output  [7:0] dataOut_5;  // uint8
  output  [7:0] dataOut_6;  // uint8
  output  [7:0] dataOut_7;  // uint8
  output  [7:0] dataOut_8;  // uint8
  output  hStartOut;
  output  hEndOut;
  output  vStartOut;
  output  vEndOut;
  ...
  wire [3:0] BooleanZero;  // ufix4
  wire hStartR;
  wire blankCountEn;
  reg [15:0] BlankingCount;  // ufix16
  wire unloading;
  wire [3:0] LineStartV;  // ufix4
  wire [3:0] popEn;  // ufix4
  wire validR;
  reg  validRREG;
  wire hEndR;
  reg  hEndRREG;
  ...
  wire [7:0] DataMemVector_3;  // uint8
  wire [7:0] DataMemVector_4;  // uint8
  wire [7:0] DataMemVector_5;  // uint8
  wire [7:0] DataMemVector_6;  // uint8
  wire [7:0] DataMemVector_7;  // uint8
  wire [7:0] DataMemVector_8;  // uint8
  wire popReg;
  wire AllEndOfLine;
  reg  AllEndOfLineREG;
  wire vEndR;
  ...
  wire Running;
  reg  outputDataREG;
  wire [7:0] constZero [0:8];  // uint8 [9]
  wire runOrUnload;
  ...
  wire [7:0] DataMemVectorPadded_3;  // uint8
  wire [7:0] DataMemVectorPadded_4;  // uint8
  wire [7:0] DataMemVectorPadded_5;  // uint8
  wire [7:0] DataMemVectorPadded_6;  // uint8
  wire [7:0] DataMemVectorPadded_7;  // uint8
  wire [7:0] DataMemVectorPadded_8;  // uint8
  wire [9:0] VerCountOut;  // ufix10
  wire [7:0] verPadOut_0;  // uint8
  wire [7:0] verPadOut_1;  // uint8
  wire [7:0] verPadOut_2;  // uint8
  wire [7:0] verPadOut_3;  // uint8
  wire [7:0] verPadOut_4;  // uint8
  wire [7:0] verPadOut_5;  // uint8
  wire [7:0] verPadOut_6;  // uint8
  wire [7:0] verPadOut_7;  // uint8
  wire [7:0] verPadOut_8;  // uint8
  wire [7:0] verPadOut [0:8];  // uint8 [9]
  reg [7:0] reg_reg [0:8];  // ufix8 [9]
  wire [7:0] reg_reg_next [0:8];  // ufix8 [9]
  wire [7:0] verPadD [0:8];  // uint8 [9]
  wire [7:0] dataSigOut [0:8];  // uint8 [9]
  reg [7:0] reg_reg_1 [0:8];  // ufix8 [9]
  wire [7:0] reg_reg_next_1 [0:8];  // ufix8 [9]
  wire [7:0] dataSigPreOD [0:8];  // uint8 [9]
  wire [7:0] dataOut [0:8];  // uint8 [9]
  wire ctrlOutZero;
  ...
  Bilateral_ip_src_InputControlValidation u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                                      .reset(reset),
                                                                      .enb(enb),
                                                                      .hStartIn(hStartInD),
                                                                      .hEndIn(hEndInD),
  ...
  Bilateral_ip_src_LineSpaceAverager u_LineSpaceAverager (.clk(clk),
                                                          .reset(reset),
                                                          .enb(enb),
  ...
  Bilateral_ip_src_DATA_MEMORY u_DATA_MEMORY (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
                                              .Unloading(unloading),
                                              ...
                                              .dataVectorOut_3(DataMemVector_3),  // uint8
                                              .dataVectorOut_4(DataMemVector_4),  // uint8
                                              .dataVectorOut_5(DataMemVector_5),  // uint8
                                              .dataVectorOut_6(DataMemVector_6),  // uint8
                                              .dataVectorOut_7(DataMemVector_7),  // uint8
                                              .dataVectorOut_8(DataMemVector_8),  // uint8
                                              .popOut(popReg),
  ...
  Bilateral_ip_src_LineInfoStore u_LINE_INFO_STORE (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .hStartIn(hStartDRC),
                                                    .Unloading(unloading),
                                                    .frameEnd(EndOrStart),
                                                    .lineStartV(LineStartV)  // ufix4
                                                    );

  Bilateral_ip_src_DataReadController u_DATA_READ_CONTROLLER (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
                                                              .hStartIn(hStartVREG),
                                                              .hEndIn(hEndV_1),
  ...
  assign constZero[3] = 8'b00000000;
  assign constZero[4] = 8'b00000000;
  assign constZero[5] = 8'b00000000;
  assign constZero[6] = 8'b00000000;
  assign constZero[7] = 8'b00000000;
  assign constZero[8] = 8'b00000000;
  ...
  Bilateral_ip_src_LineInfoStore_block u_State_Transition_Flag_Gen (.clk(clk),
                                                                    .reset(reset),
                                                                    .enb(enb),
                                                                    .hStartIn(hStartDRC),
                                                                    .hEndIn(hEndRDT),
  ...
  Bilateral_ip_src_PaddingController u_Padding_Controller (.clk(clk),
                                                           .reset(reset),
                                                           .enb(enb),
                                                           .PrePadFlag(PrePadFlag),
                                                           .OnLineFlag(OnLineFlag),
  ...
  Bilateral_ip_src_GateProcessData u_Gate_Process_Data (.clk(clk),
                                                        .reset(reset),
                                                        .enb(enb),
  ...
  assign DataMemVector[4] = DataMemVector_4;
  assign DataMemVector[5] = DataMemVector_5;
  assign DataMemVector[6] = DataMemVector_6;
  assign DataMemVector[7] = DataMemVector_7;
  assign DataMemVector[8] = DataMemVector_8;
  ...
  assign DataMemVectorREG[4] = intdelay_reg_9[4];
  assign DataMemVectorREG[5] = intdelay_reg_9[5];
  assign DataMemVectorREG[6] = intdelay_reg_9[6];
  assign DataMemVectorREG[7] = intdelay_reg_9[7];
  assign DataMemVectorREG[8] = intdelay_reg_9[8];
  ...
  assign intdelay_reg_next_9[4] = DataMemVector[4];
  assign intdelay_reg_next_9[5] = DataMemVector[5];
  assign intdelay_reg_next_9[6] = DataMemVector[6];
  assign intdelay_reg_next_9[7] = DataMemVector[7];
  assign intdelay_reg_next_9[8] = DataMemVector[8];
  ...
  Bilateral_ip_src_Horizontal_Padder u_Horizontal_Padder (.clk(clk),
                                                          .reset(reset),
                                                          .enb(enb),
                                                          .dataVectorIn_0(DataMemVectorREG[0]),  // uint8
                                                          .dataVectorIn_1(DataMemVectorREG[1]),  // uint8
                                                          .dataVectorIn_2(DataMemVectorREG[2]),  // uint8
                                                          .dataVectorIn_3(DataMemVectorREG[3]),  // uint8
                                                          .dataVectorIn_4(DataMemVectorREG[4]),  // uint8
                                                          .dataVectorIn_5(DataMemVectorREG[5]),  // uint8
                                                          .dataVectorIn_6(DataMemVectorREG[6]),  // uint8
                                                          .dataVectorIn_7(DataMemVectorREG[7]),  // uint8
                                                          .dataVectorIn_8(DataMemVectorREG[8]),  // uint8
                                                          ...
                                                          .dataVector_3(DataMemVectorPadded_3),  // uint8
                                                          .dataVector_4(DataMemVectorPadded_4),  // uint8
                                                          .dataVector_5(DataMemVectorPadded_5),  // uint8
                                                          .dataVector_6(DataMemVectorPadded_6),  // uint8
                                                          .dataVector_7(DataMemVectorPadded_7),  // uint8
                                                          .dataVector_8(DataMemVectorPadded_8)  // uint8
                                                          );

  Bilateral_ip_src_Vertical_Padding_Counter u_Vertical_Counter (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
                                                                .frameEnd(vStartIn),
                                                                .unloading(unloading),
  ...
  Bilateral_ip_src_Vertical_Padder u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // uint8
                                                      .dataVectorIn_1(DataMemVectorPadded_1),  // uint8
                                                      .dataVectorIn_2(DataMemVectorPadded_2),  // uint8
                                                      .dataVectorIn_3(DataMemVectorPadded_3),  // uint8
                                                      .dataVectorIn_4(DataMemVectorPadded_4),  // uint8
                                                      .dataVectorIn_5(DataMemVectorPadded_5),  // uint8
                                                      .dataVectorIn_6(DataMemVectorPadded_6),  // uint8
                                                      .dataVectorIn_7(DataMemVectorPadded_7),  // uint8
                                                      .dataVectorIn_8(DataMemVectorPadded_8),  // uint8
                                                      ...
                                                      .dataVectorOut_3(verPadOut_3),  // uint8
                                                      .dataVectorOut_4(verPadOut_4),  // uint8
                                                      .dataVectorOut_5(verPadOut_5),  // uint8
                                                      .dataVectorOut_6(verPadOut_6),  // uint8
                                                      .dataVectorOut_7(verPadOut_7),  // uint8
                                                      .dataVectorOut_8(verPadOut_8)  // uint8
                                                      );
  ...
  assign verPadOut[4] = verPadOut_4;
  assign verPadOut[5] = verPadOut_5;
  assign verPadOut[6] = verPadOut_6;
  assign verPadOut[7] = verPadOut_7;
  assign verPadOut[8] = verPadOut_8;
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_13_process
      if (reset == 1'b1) begin
        ...
        reg_reg[3] <= 8'b00000000;
        reg_reg[4] <= 8'b00000000;
        reg_reg[5] <= 8'b00000000;
        reg_reg[6] <= 8'b00000000;
        reg_reg[7] <= 8'b00000000;
        reg_reg[8] <= 8'b00000000;
      end
      else begin
        if (enb) begin
          ...
          reg_reg[4] <= reg_reg_next[4];
          reg_reg[5] <= reg_reg_next[5];
          reg_reg[6] <= reg_reg_next[6];
          reg_reg[7] <= reg_reg_next[7];
          reg_reg[8] <= reg_reg_next[8];
        end
      end
    end
  ...
  assign verPadD[4] = reg_reg[4];
  assign verPadD[5] = reg_reg[5];
  assign verPadD[6] = reg_reg[6];
  assign verPadD[7] = reg_reg[7];
  assign verPadD[8] = reg_reg[8];
  ...
  assign reg_reg_next[4] = verPadOut[4];
  assign reg_reg_next[5] = verPadOut[5];
  assign reg_reg_next[6] = verPadOut[6];
  assign reg_reg_next[7] = verPadOut[7];
  assign reg_reg_next[8] = verPadOut[8];
  ...
  assign dataSigOut[3] = (outputProcess == 1'b0 ? constZero[3] :
              verPadD[3]);
  assign dataSigOut[4] = (outputProcess == 1'b0 ? constZero[4] :
              verPadD[4]);
  assign dataSigOut[5] = (outputProcess == 1'b0 ? constZero[5] :
              verPadD[5]);
  assign dataSigOut[6] = (outputProcess == 1'b0 ? constZero[6] :
              verPadD[6]);
  assign dataSigOut[7] = (outputProcess == 1'b0 ? constZero[7] :
              verPadD[7]);
  assign dataSigOut[8] = (outputProcess == 1'b0 ? constZero[8] :
              verPadD[8]);
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_14_process
      if (reset == 1'b1) begin
        ...
        reg_reg_1[3] <= 8'b00000000;
        reg_reg_1[4] <= 8'b00000000;
        reg_reg_1[5] <= 8'b00000000;
        reg_reg_1[6] <= 8'b00000000;
        reg_reg_1[7] <= 8'b00000000;
        reg_reg_1[8] <= 8'b00000000;
      end
      else begin
        if (enb) begin
          ...
          reg_reg_1[4] <= reg_reg_next_1[4];
          reg_reg_1[5] <= reg_reg_next_1[5];
          reg_reg_1[6] <= reg_reg_next_1[6];
          reg_reg_1[7] <= reg_reg_next_1[7];
          reg_reg_1[8] <= reg_reg_next_1[8];
        end
      end
    end
  ...
  assign dataSigPreOD[4] = reg_reg_1[4];
  assign dataSigPreOD[5] = reg_reg_1[5];
  assign dataSigPreOD[6] = reg_reg_1[6];
  assign dataSigPreOD[7] = reg_reg_1[7];
  assign dataSigPreOD[8] = reg_reg_1[8];
  ...
  assign reg_reg_next_1[4] = dataSigOut[4];
  assign reg_reg_next_1[5] = dataSigOut[5];
  assign reg_reg_next_1[6] = dataSigOut[6];
  assign reg_reg_next_1[7] = dataSigOut[7];
  assign reg_reg_next_1[8] = dataSigOut[8];
  ...
  assign dataOut[3] = (outputDataREG == 1'b0 ? constZero[3] :
              dataSigPreOD[3]);
  assign dataOut[4] = (outputDataREG == 1'b0 ? constZero[4] :
              dataSigPreOD[4]);
  assign dataOut[5] = (outputDataREG == 1'b0 ? constZero[5] :
              dataSigPreOD[5]);
  assign dataOut[6] = (outputDataREG == 1'b0 ? constZero[6] :
              dataSigPreOD[6]);
  assign dataOut[7] = (outputDataREG == 1'b0 ? constZero[7] :
              dataSigPreOD[7]);
  assign dataOut[8] = (outputDataREG == 1'b0 ? constZero[8] :
              dataSigPreOD[8]);
  ...
  assign dataOut_4 = dataOut[4];

  assign dataOut_5 = dataOut[5];

  assign dataOut_6 = dataOut[6];

  assign dataOut_7 = dataOut[7];

  assign dataOut_8 = dataOut[8];
...
endmodule  // Bilateral_ip_src_LineBuffer
