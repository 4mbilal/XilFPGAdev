// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BilateralFilterIP\Bilateral_ip_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: Bilateral_ip_fifo_data_OUT
// Source Path: Bilateral_ip/Bilateral_ip_axi4_stream_video_master/Bilateral_ip_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Bilateral_ip_fifo_data_OUT
  ...
  Bilateral_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                           .DataWidth(32)
                                           )
                                         u_Bilateral_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                           .enb(enb),
                                                                                           .wr_din(In),
                                                                                           .wr_addr(w_waddr),
                                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // Bilateral_ip_fifo_data_OUT
