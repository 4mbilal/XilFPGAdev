// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BilateralFilterIP\Bilateral_ip.v
...
module Bilateral_ip
  ...
  assign ip_timestamp = 32'b01111101011010101110111101110011;
  ...
  Bilateral_ip_reset_sync u_Bilateral_ip_reset_sync_inst (.clk(IPCORE_CLK),  // ufix1
                                                          .reset_in(reset_before_sync),  // ufix1
                                                          .reset_out(reset)
                                                          );

  Bilateral_ip_axi_lite u_Bilateral_ip_axi_lite_inst (.reset(reset),
  ...
  Bilateral_ip_axi4_stream_video_slave u_Bilateral_ip_axi4_stream_video_slave_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                    .reset(reset),
                                                                                    .enb(const_1),
  ...
  Bilateral_ip_dut u_Bilateral_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                            .reset(reset),
  ...
  Bilateral_ip_axi4_stream_video_master u_Bilateral_ip_axi4_stream_video_master_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                      .reset(reset),
                                                                                      .enb(const_1),
