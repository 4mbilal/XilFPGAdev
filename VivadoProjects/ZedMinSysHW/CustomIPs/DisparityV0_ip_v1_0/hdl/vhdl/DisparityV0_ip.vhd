-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DisparityV0_ip.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DisparityV0_ip
-- Source Path: DisparityV0_ip
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF DisparityV0_ip IS

  -- Component Declarations
  COMPONENT DisparityV0_ip_reset_sync
  ...
  COMPONENT DisparityV0_ip_axi_lite
  ...
  COMPONENT DisparityV0_ip_axi4_stream_video_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Slave_TDATA   :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT DisparityV0_ip_axi4_stream_video_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Master_TREADY :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DisparityV0_ip_reset_sync
    USE ENTITY work.DisparityV0_ip_reset_sync(rtl);

  FOR ALL : DisparityV0_ip_axi_lite
    USE ENTITY work.DisparityV0_ip_axi_lite(rtl);

  FOR ALL : DisparityV0_ip_axi4_stream_video_slave
    USE ENTITY work.DisparityV0_ip_axi4_stream_video_slave(rtl);

  FOR ALL : DisparityV0_ip_dut
    USE ENTITY work.DisparityV0_ip_dut(rtl);

  FOR ALL : DisparityV0_ip_axi4_stream_video_master
    USE ENTITY work.DisparityV0_ip_axi4_stream_video_master(rtl);
...
BEGIN
  u_DisparityV0_ip_reset_sync_inst : DisparityV0_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_DisparityV0_ip_axi_lite_inst : DisparityV0_ip_axi_lite
  ...
  u_DisparityV0_ip_axi4_stream_video_slave_inst : DisparityV0_ip_axi4_stream_video_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_DisparityV0_ip_dut_inst : DisparityV0_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_DisparityV0_ip_axi4_stream_video_master_inst : DisparityV0_ip_axi4_stream_video_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= to_unsigned(2104250829, 32);
