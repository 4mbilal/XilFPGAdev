-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DisparityV0_ip_fifo_sof_out.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DisparityV0_ip_fifo_sof_out
-- Source Path: DisparityV0_ip/DisparityV0_ip_axi4_stream_video_master/DisparityV0_ip_fifo_sof_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DisparityV0_ip_fifo_sof_out IS
...
END DisparityV0_ip_fifo_sof_out;


ARCHITECTURE rtl OF DisparityV0_ip_fifo_sof_out IS

  -- Component Declarations
  COMPONENT DisparityV0_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : DisparityV0_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.DisparityV0_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_DisparityV0_ip_fifo_sof_out_classic_ram_singlebit : DisparityV0_ip_SimpleDualPortRAM_singlebit
