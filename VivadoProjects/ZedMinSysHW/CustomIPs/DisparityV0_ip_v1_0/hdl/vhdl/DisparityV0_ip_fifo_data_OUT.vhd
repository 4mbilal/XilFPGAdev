-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\DisparityV0_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DisparityV0_ip_fifo_data_OUT
-- Source Path: DisparityV0_ip/DisparityV0_ip_axi4_stream_video_master/DisparityV0_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DisparityV0_ip_fifo_data_OUT IS
...
END DisparityV0_ip_fifo_data_OUT;


ARCHITECTURE rtl OF DisparityV0_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT DisparityV0_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : DisparityV0_ip_SimpleDualPortRAM_generic
    USE ENTITY work.DisparityV0_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_DisparityV0_ip_fifo_data_OUT_classic_ram_generic : DisparityV0_ip_SimpleDualPortRAM_generic
