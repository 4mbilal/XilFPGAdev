-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_fifo_eol.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_fifo_eol
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_slave/Disparity_ip_fifo_eol
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_fifo_eol IS
...
END Disparity_ip_fifo_eol;


ARCHITECTURE rtl OF Disparity_ip_fifo_eol IS
...
BEGIN
  ...
  u_Disparity_ip_fifo_eol_classic_ram : Disparity_ip_SimpleDualPortRAM_singlebit
