-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_fifo_data_OUT
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_master/Disparity_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_fifo_data_OUT IS
...
END Disparity_ip_fifo_data_OUT;


ARCHITECTURE rtl OF Disparity_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT Disparity_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : Disparity_ip_SimpleDualPortRAM_generic
    USE ENTITY work.Disparity_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_Disparity_ip_fifo_data_OUT_classic_ram_generic : Disparity_ip_SimpleDualPortRAM_generic
