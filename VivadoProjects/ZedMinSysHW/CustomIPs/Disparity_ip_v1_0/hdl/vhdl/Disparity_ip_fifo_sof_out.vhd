-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_fifo_sof_out.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_fifo_sof_out
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_master/Disparity_ip_fifo_sof_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_fifo_sof_out IS
...
END Disparity_ip_fifo_sof_out;


ARCHITECTURE rtl OF Disparity_ip_fifo_sof_out IS

  -- Component Declarations
  COMPONENT Disparity_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : Disparity_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.Disparity_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_Disparity_ip_fifo_sof_out_classic_ram_singlebit : Disparity_ip_SimpleDualPortRAM_singlebit
