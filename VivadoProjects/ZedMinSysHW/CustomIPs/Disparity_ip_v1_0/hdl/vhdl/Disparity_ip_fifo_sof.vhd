-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_fifo_sof.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_fifo_sof
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_slave/Disparity_ip_fifo_sof
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_fifo_sof IS
...
END Disparity_ip_fifo_sof;


ARCHITECTURE rtl OF Disparity_ip_fifo_sof IS
...
BEGIN
  ...
  u_Disparity_ip_fifo_sof_classic_ram : Disparity_ip_SimpleDualPortRAM_singlebit
