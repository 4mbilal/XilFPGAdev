-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_fifo_data
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_slave/Disparity_ip_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_fifo_data IS
...
END Disparity_ip_fifo_data;


ARCHITECTURE rtl OF Disparity_ip_fifo_data IS
...
BEGIN
  ...
  u_Disparity_ip_fifo_data_classic_ram : Disparity_ip_SimpleDualPortRAM_generic
