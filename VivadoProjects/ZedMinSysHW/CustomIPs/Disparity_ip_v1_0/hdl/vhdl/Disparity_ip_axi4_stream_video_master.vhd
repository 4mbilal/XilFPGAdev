-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_axi4_stream_video_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_axi4_stream_video_master
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_axi4_stream_video_master IS
...
END Disparity_ip_axi4_stream_video_master;


ARCHITECTURE rtl OF Disparity_ip_axi4_stream_video_master IS

  -- Component Declarations
  COMPONENT Disparity_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Disparity_ip_fifo_eol_out
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Disparity_ip_fifo_sof_out
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Disparity_ip_fifo_data_OUT
    USE ENTITY work.Disparity_ip_fifo_data_OUT(rtl);

  FOR ALL : Disparity_ip_fifo_eol_out
    USE ENTITY work.Disparity_ip_fifo_eol_out(rtl);

  FOR ALL : Disparity_ip_fifo_sof_out
    USE ENTITY work.Disparity_ip_fifo_sof_out(rtl);
...
BEGIN
  u_Disparity_ip_fifo_data_OUT_inst : Disparity_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Disparity_ip_fifo_eol_out_inst : Disparity_ip_fifo_eol_out
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Disparity_ip_fifo_sof_out_inst : Disparity_ip_fifo_sof_out
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
