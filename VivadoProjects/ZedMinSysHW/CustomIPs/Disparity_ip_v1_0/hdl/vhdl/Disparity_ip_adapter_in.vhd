-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_adapter_in.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_adapter_in
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_slave/Disparity_ip_adapter_in
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_adapter_in IS
...
END Disparity_ip_adapter_in;


ARCHITECTURE rtl OF Disparity_ip_adapter_in IS

  -- Component Declarations
  COMPONENT Disparity_ip_adapter_in_module
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Disparity_ip_adapter_in_module
    USE ENTITY work.Disparity_ip_adapter_in_module(rtl);

  -- Signals
  SIGNAL user_pixel_tmp                   : std_logic_vector(31 DOWNTO 0);  -- ufix32

BEGIN
  u_Disparity_ip_Disparity_ip_axi4_stream_video_slave_Disparity_ip_adapter_in_Disparity_ip_adapter_in_module : Disparity_ip_adapter_in_module
    PORT MAP( clk => clk,
              reset => reset,
