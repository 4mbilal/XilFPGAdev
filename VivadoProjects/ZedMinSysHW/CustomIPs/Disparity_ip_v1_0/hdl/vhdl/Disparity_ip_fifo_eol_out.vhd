-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_fifo_eol_out.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_fifo_eol_out
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_master/Disparity_ip_fifo_eol_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_fifo_eol_out IS
...
END Disparity_ip_fifo_eol_out;


ARCHITECTURE rtl OF Disparity_ip_fifo_eol_out IS
...
BEGIN
  ...
  u_Disparity_ip_fifo_eol_out_classic_ram : Disparity_ip_SimpleDualPortRAM_singlebit
