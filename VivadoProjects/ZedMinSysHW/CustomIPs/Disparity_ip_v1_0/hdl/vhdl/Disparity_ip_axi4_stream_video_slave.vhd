-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip_axi4_stream_video_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Disparity_ip_axi4_stream_video_slave
-- Source Path: Disparity_ip/Disparity_ip_axi4_stream_video_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Disparity_ip_axi4_stream_video_slave IS
...
END Disparity_ip_axi4_stream_video_slave;


ARCHITECTURE rtl OF Disparity_ip_axi4_stream_video_slave IS

  -- Component Declarations
  COMPONENT Disparity_ip_fifo_eol
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Disparity_ip_fifo_sof
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT Disparity_ip_adapter_in
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT Disparity_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Disparity_ip_fifo_eol
    USE ENTITY work.Disparity_ip_fifo_eol(rtl);

  FOR ALL : Disparity_ip_fifo_sof
    USE ENTITY work.Disparity_ip_fifo_sof(rtl);

  FOR ALL : Disparity_ip_adapter_in
    USE ENTITY work.Disparity_ip_adapter_in(rtl);

  FOR ALL : Disparity_ip_fifo_data
    USE ENTITY work.Disparity_ip_fifo_data(rtl);
...
BEGIN
  u_Disparity_ip_fifo_eol_inst : Disparity_ip_fifo_eol
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Disparity_ip_fifo_sof_inst : Disparity_ip_fifo_sof
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Disparity_ip_Disparity_ip_axi4_stream_video_slave_Disparity_ip_adapter_in : Disparity_ip_adapter_in
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Disparity_ip_fifo_data_inst : Disparity_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
