-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Disparity_CT\Disparity_ip.vhd
...
ARCHITECTURE rtl OF Disparity_ip IS

  -- Component Declarations
  COMPONENT Disparity_ip_reset_sync
  ...
  COMPONENT Disparity_ip_axi_lite
  ...
  COMPONENT Disparity_ip_axi4_stream_video_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Slave_TDATA   :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT Disparity_ip_axi4_stream_video_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Master_TREADY :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Disparity_ip_reset_sync
    USE ENTITY work.Disparity_ip_reset_sync(rtl);

  FOR ALL : Disparity_ip_axi_lite
    USE ENTITY work.Disparity_ip_axi_lite(rtl);

  FOR ALL : Disparity_ip_axi4_stream_video_slave
    USE ENTITY work.Disparity_ip_axi4_stream_video_slave(rtl);

  FOR ALL : Disparity_ip_dut
    USE ENTITY work.Disparity_ip_dut(rtl);

  FOR ALL : Disparity_ip_axi4_stream_video_master
    USE ENTITY work.Disparity_ip_axi4_stream_video_master(rtl);
...
BEGIN
  u_Disparity_ip_reset_sync_inst : Disparity_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_Disparity_ip_axi_lite_inst : Disparity_ip_axi_lite
  ...
  u_Disparity_ip_axi4_stream_video_slave_inst : Disparity_ip_axi4_stream_video_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_Disparity_ip_dut_inst : Disparity_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_Disparity_ip_axi4_stream_video_master_inst : Disparity_ip_axi4_stream_video_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= to_unsigned(2104241426, 32);
  ...
  ctrl_valid_sig <= top_user_ctrl_valid_1;

  ctrl_vEnd_sig <= top_user_ctrl_vEnd_1;

  ctrl_vStart_sig <= top_user_ctrl_vStart_1;

  ctrl_hEnd_sig <= top_user_ctrl_hEnd_1;

  ctrl_hStart_sig <= top_user_ctrl_hStart_1;
