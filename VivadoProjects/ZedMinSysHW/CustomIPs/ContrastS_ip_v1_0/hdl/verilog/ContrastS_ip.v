// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip.v
...
module ContrastS_ip
  ...
  assign ip_timestamp = 32'b01111101011010110001100000001000;
  ...
  ContrastS_ip_reset_sync u_ContrastS_ip_reset_sync_inst (.clk(IPCORE_CLK),  // ufix1
                                                          .reset_in(reset_before_sync),  // ufix1
                                                          .reset_out(reset)
                                                          );

  ContrastS_ip_axi_lite u_ContrastS_ip_axi_lite_inst (.reset(reset),
  ...
  ContrastS_ip_axi4_stream_video_slave u_ContrastS_ip_axi4_stream_video_slave_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                    .reset(reset),
                                                                                    .enb(const_1),
  ...
  ContrastS_ip_dut u_ContrastS_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                            .reset(reset),
  ...
  ContrastS_ip_axi4_stream_video_master u_ContrastS_ip_axi4_stream_video_master_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                      .reset(reset),
                                                                                      .enb(const_1),
