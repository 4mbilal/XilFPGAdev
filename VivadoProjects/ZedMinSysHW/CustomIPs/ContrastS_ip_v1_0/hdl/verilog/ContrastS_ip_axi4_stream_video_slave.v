// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_axi4_stream_video_slave.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_axi4_stream_video_slave
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module ContrastS_ip_axi4_stream_video_slave
  ...
  ContrastS_ip_fifo_eol u_ContrastS_ip_fifo_eol_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  ContrastS_ip_fifo_sof u_ContrastS_ip_fifo_sof_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  ContrastS_ip_adapter_in u_ContrastS_ip_ContrastS_ip_axi4_stream_video_slave_ContrastS_ip_adapter_in (.clk(clk),
                                                                                                       .reset(reset),
  ...
  ContrastS_ip_fifo_data u_ContrastS_ip_fifo_data_inst (.clk(clk),
                                                        .reset(reset),
                                                        .enb(enb),
...
endmodule  // ContrastS_ip_axi4_stream_video_slave
