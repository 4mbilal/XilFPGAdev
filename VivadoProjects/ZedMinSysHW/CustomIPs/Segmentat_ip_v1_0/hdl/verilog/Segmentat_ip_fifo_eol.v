// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip_fifo_eol.v
...
// -------------------------------------------------------------
// 
// Module: Segmentat_ip_fifo_eol
// Source Path: Segmentat_ip/Segmentat_ip_axi4_stream_video_slave/Segmentat_ip_fifo_eol
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Segmentat_ip_fifo_eol
  ...
  Segmentat_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                           ...
                                           u_Segmentat_ip_fifo_eol_classic_ram (.clk(clk),
                                                                                .enb(enb),
                                                                                .wr_din(In),  // ufix1
                                                                                .wr_addr(w_waddr),
                                                                                .wr_en(w_we),  // ufix1
...
endmodule  // Segmentat_ip_fifo_eol
