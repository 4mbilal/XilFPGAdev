// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip_fifo_sof_out.v
...
// -------------------------------------------------------------
// 
// Module: Segmentat_ip_fifo_sof_out
// Source Path: Segmentat_ip/Segmentat_ip_axi4_stream_video_master/Segmentat_ip_fifo_sof_out
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Segmentat_ip_fifo_sof_out
  ...
  Segmentat_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                             .DataWidth(1)
                                             )
                                           u_Segmentat_ip_fifo_sof_out_classic_ram_singlebit (.clk(clk),
                                                                                              .enb(enb),
                                                                                              .wr_din(In),  // ufix1
                                                                                              .wr_addr(w_waddr),
                                                                                              .wr_en(w_we),  // ufix1
...
endmodule  // Segmentat_ip_fifo_sof_out
