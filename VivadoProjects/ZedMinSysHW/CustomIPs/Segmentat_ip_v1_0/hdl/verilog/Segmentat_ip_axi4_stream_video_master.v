// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip_axi4_stream_video_master.v
...
// -------------------------------------------------------------
// 
// Module: Segmentat_ip_axi4_stream_video_master
// Source Path: Segmentat_ip/Segmentat_ip_axi4_stream_video_master
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Segmentat_ip_axi4_stream_video_master
  ...
  Segmentat_ip_fifo_data_OUT u_Segmentat_ip_fifo_data_OUT_inst (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
  ...
  Segmentat_ip_fifo_eol_out u_Segmentat_ip_fifo_eol_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
  ...
  Segmentat_ip_fifo_sof_out u_Segmentat_ip_fifo_sof_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
...
endmodule  // Segmentat_ip_axi4_stream_video_master
