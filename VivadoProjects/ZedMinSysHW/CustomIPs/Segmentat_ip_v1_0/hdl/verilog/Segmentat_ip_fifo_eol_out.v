// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip_fifo_eol_out.v
...
// -------------------------------------------------------------
// 
// Module: Segmentat_ip_fifo_eol_out
// Source Path: Segmentat_ip/Segmentat_ip_axi4_stream_video_master/Segmentat_ip_fifo_eol_out
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Segmentat_ip_fifo_eol_out
  ...
  Segmentat_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                           ...
                                           u_Segmentat_ip_fifo_eol_out_classic_ram (.clk(clk),
                                                                                    .enb(enb),
                                                                                    .wr_din(In),  // ufix1
                                                                                    .wr_addr(w_waddr),
                                                                                    .wr_en(w_we),  // ufix1
...
endmodule  // Segmentat_ip_fifo_eol_out
