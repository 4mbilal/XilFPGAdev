// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip_SimpleDualPortRAM_generic.v
...
// -------------------------------------------------------------
// 
// Module: Segmentat_ip_SimpleDualPortRAM_generic
// Source Path: Segmentat_ip/Segmentat_ip_axi4_stream_video_master/Segmentat_ip_fifo_data_OUT/Segmentat_ip_fifo_data_OUT_classic/Segmentat_ip_SimpleDualPortRAM_generic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Segmentat_ip_SimpleDualPortRAM_generic
  ...
  always @(posedge clk)
    begin : Segmentat_ip_SimpleDualPortRAM_generic_process
      if (enb == 1'b1) begin
        if (wr_en == 1'b1) begin
          ram[wr_addr] <= wr_din;
        end
...
endmodule  // Segmentat_ip_SimpleDualPortRAM_generic
