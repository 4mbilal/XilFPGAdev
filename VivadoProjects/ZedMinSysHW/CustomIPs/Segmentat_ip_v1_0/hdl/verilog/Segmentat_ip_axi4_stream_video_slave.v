// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip_axi4_stream_video_slave.v
...
// -------------------------------------------------------------
// 
// Module: Segmentat_ip_axi4_stream_video_slave
// Source Path: Segmentat_ip/Segmentat_ip_axi4_stream_video_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Segmentat_ip_axi4_stream_video_slave
  ...
  Segmentat_ip_fifo_eol u_Segmentat_ip_fifo_eol_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  Segmentat_ip_fifo_sof u_Segmentat_ip_fifo_sof_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  Segmentat_ip_adapter_in u_Segmentat_ip_Segmentat_ip_axi4_stream_video_slave_Segmentat_ip_adapter_in (.clk(clk),
                                                                                                       .reset(reset),
  ...
  Segmentat_ip_fifo_data u_Segmentat_ip_fifo_data_inst (.clk(clk),
                                                        .reset(reset),
                                                        .enb(enb),
...
endmodule  // Segmentat_ip_axi4_stream_video_slave
