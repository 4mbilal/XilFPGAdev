// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\Sementation_4K_480p\Segmentat_ip.v
...
module Segmentat_ip
  ...
  assign ip_timestamp = 32'b01111101011010110001110001111110;
  ...
  Segmentat_ip_reset_sync u_Segmentat_ip_reset_sync_inst (.clk(IPCORE_CLK),  // ufix1
                                                          .reset_in(reset_before_sync),  // ufix1
                                                          .reset_out(reset)
                                                          );

  Segmentat_ip_axi_lite u_Segmentat_ip_axi_lite_inst (.reset(reset),
  ...
  Segmentat_ip_axi4_stream_video_slave u_Segmentat_ip_axi4_stream_video_slave_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                    .reset(reset),
                                                                                    .enb(const_1),
  ...
  Segmentat_ip_dut u_Segmentat_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                            .reset(reset),
  ...
  Segmentat_ip_axi4_stream_video_master u_Segmentat_ip_axi4_stream_video_master_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                      .reset(reset),
                                                                                      .enb(const_1),
