// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\RGB2GrayIP\RGB2Gray_ip_axi4_stream_video_slave.v
...
// -------------------------------------------------------------
// 
// Module: RGB2Gray_ip_axi4_stream_video_slave
// Source Path: RGB2Gray_ip/RGB2Gray_ip_axi4_stream_video_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module RGB2Gray_ip_axi4_stream_video_slave
  ...
  RGB2Gray_ip_fifo_eol u_RGB2Gray_ip_fifo_eol_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
  ...
  RGB2Gray_ip_fifo_sof u_RGB2Gray_ip_fifo_sof_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
  ...
  RGB2Gray_ip_adapter_in u_RGB2Gray_ip_RGB2Gray_ip_axi4_stream_video_slave_RGB2Gray_ip_adapter_in (.clk(clk),
                                                                                                   .reset(reset),
  ...
  RGB2Gray_ip_fifo_data u_RGB2Gray_ip_fifo_data_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
...
endmodule  // RGB2Gray_ip_axi4_stream_video_slave
