// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\RGB2GrayIP\RGB2Gray_ip_axi4_stream_video_master.v
...
// -------------------------------------------------------------
// 
// Module: RGB2Gray_ip_axi4_stream_video_master
// Source Path: RGB2Gray_ip/RGB2Gray_ip_axi4_stream_video_master
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module RGB2Gray_ip_axi4_stream_video_master
  ...
  RGB2Gray_ip_fifo_data_OUT u_RGB2Gray_ip_fifo_data_OUT_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
  ...
  RGB2Gray_ip_fifo_eol_out u_RGB2Gray_ip_fifo_eol_out_inst (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
  ...
  RGB2Gray_ip_fifo_sof_out u_RGB2Gray_ip_fifo_sof_out_inst (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
...
endmodule  // RGB2Gray_ip_axi4_stream_video_master
