// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\RGB2GrayIP\RGB2Gray_ip_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: RGB2Gray_ip_fifo_data_OUT
// Source Path: RGB2Gray_ip/RGB2Gray_ip_axi4_stream_video_master/RGB2Gray_ip_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RGB2Gray_ip_fifo_data_OUT
  ...
  RGB2Gray_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                          .DataWidth(32)
                                          )
                                        u_RGB2Gray_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                         .enb(enb),
                                                                                         .wr_din(In),
                                                                                         .wr_addr(w_waddr),
                                                                                         .wr_en(w_we),  // ufix1
...
endmodule  // RGB2Gray_ip_fifo_data_OUT
