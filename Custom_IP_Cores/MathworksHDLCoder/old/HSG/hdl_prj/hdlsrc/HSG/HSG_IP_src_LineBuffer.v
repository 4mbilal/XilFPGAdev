// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_LineBuffer.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_LineBuffer
// Source Path: HSG/HSG/Edge Detector/LineBuffer
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HSG_IP_src_LineBuffer
  ...
  reg [7:0] intdelay_reg [0:4];  // ufix8 [5]
  wire [7:0] intdelay_reg_next [0:4];  // ufix8 [5]
  wire [7:0] inputREG;  // uint8
  wire hStartV;
  wire hEndV;
  wire vStartV;
  wire vEndV;
  ...
  wire hStartDataMem;
  reg  hStartREG;
  wire [1:0] lineMask;  // ufix2
  reg [1:0] lineMaskD;  // ufix2
  wire unloadvEndOut;
  reg  unloadvEndOut_1;
  wire unloadhEndOutD;
  wire hEndIn_1;
  ...
  wire LineOut;
  reg  LineOutREG;
  wire upperHalfPop;  // ufix1
  reg  upperHalfPop_1;  // ufix1
  wire [1:0] popFIFO;  // ufix2
  reg [1:0] popFIFO_1;  // ufix2
  wire [1:0] pushFIFO;  // ufix2
  reg [1:0] pushFIFO_1;  // ufix2
  wire InitializeFlag;
  wire unloadSEL;
  wire [7:0] DATA1;  // uint8
  wire [7:0] DATA2;  // uint8
  wire allLineStart;
  ...
  wire [1:0] horMUXSEL;  // ufix2
  wire [1:0] verMUXSEL;  // ufix2
  wire hStartOut_1;
  wire hEndOut_1;
  wire hStartOut_2;
  wire hStartOut_3;
  ...
  wire [7:0] constLOW;  // uint8
  reg [7:0] intdelay_reg_10 [0:1];  // ufix8 [2]
  wire [7:0] intdelay_reg_next_10 [0:1];  // ufix8 [2]
  wire [7:0] horDataIn;  // uint8
  reg [1:0] horMUXSELREG;  // ufix2
  wire [7:0] dataHor1;  // uint8
  wire [7:0] dataHor2;  // uint8
  wire [7:0] dataHor3;  // uint8
  wire [7:0] dataVer1;  // uint8
  wire [7:0] dataVer2;  // uint8
  wire [7:0] dataVer3;  // uint8
  wire [7:0] dataREGIn1;  // uint8
  reg [7:0] dataVer1_1;  // uint8
  wire [7:0] dataREGIn2;  // uint8
  reg [7:0] dataVer2_1;  // uint8
  wire [7:0] dataREGIn3;  // uint8
  reg [7:0] dataVer3_1;  // uint8
  ...
  HSG_IP_src_InputControlValidation u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
                                                                .hStartIn(hStartIn),
                                                                .hEndIn(hEndIn),
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          LineSpaceStoreEn_1 <= LineSpaceStoreEn;
        end
      end
    end
  ...
  HSG_IP_src_lineSpaceAverager u_LINE_SPACE_AVERAGER (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .lineSpace(countLineSpaceOutD),  // ufix12
                                                      .lineCountEn(LineSpaceStoreEn_1),
                                                      .lineSpaceAverage(lineSpaceAverage)  // ufix12
                                                      );

  HSG_IP_src_lineSpaceStore u_LINE_SPACE_STORE (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
  ...
  HSG_IP_src_dataReadFSM u_DATA_READ_FSM (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
  ...
  HSG_IP_src_DataMemory u_DATA_MEMORY (.clk(clk),
                                       .reset(reset),
                                       .enb(enb),
                                       .dataIn(inputREG),  // uint8
                                       .pushFIFO(pushFIFO_1),  // ufix2
                                       .popFIFO(popFIFO_1),  // ufix2
                                       .upperPop(upperHalfPop_1),  // ufix1
                                       .lineIn(LineOutREG),
                                       .lineMask(lineMaskD),  // ufix2
                                       .hStartIn(hStartREG),
                                       .load(loadCacheD),
                                       .InitializeFlag(InitializeFlag),
                                       .loadingFlag(loadingFlagREG),
                                       .unloadSEL(unloadSEL),
                                       .loadingPaddingRunCount(loadPadCount_1),  // ufix8
                                       .dataOut1(DATA1),  // uint8
                                       .dataOut2(DATA2),  // uint8
  ...
  HSG_IP_src_FIFOHandlerFSM u_FIFO_HANDLER (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .allLineStart(allLineStart),
                                            .hStartIn(hStartD),
                                            ...
                                            .hEndIn(hEndD),
                                            .halfLoaded(halfLoaded),
                                            .pushFIFO(pushFIFO),  // ufix2
                                            .popFIFO(popFIFO),  // ufix2
                                            .upperPop(upperHalfPop),  // ufix1
                                            .InitializeFlag(InitializeFlag),
  ...
  HSG_IP_src_controlCache u_CONTROL_CACHE (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .hStartIn(hStartIn_1),
                                           .hEndIn(hEndIn_1),
  ...
  HSG_IP_src_validPipeline u_VALID_PIPELINE (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
                                             .validIn(validS),
  ...
  HSG_IP_src_dataWriteFSM u_DATA_WRITE_FSM (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            ...
                                            .horMUXSEL(horMUXSEL),  // ufix2
                                            .verMUXSEL(verMUXSEL),  // ufix2
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_10_process
      if (reset == 1'b1) begin
        intdelay_reg_10[0] <= 8'b00000000;
        intdelay_reg_10[1] <= 8'b00000000;
      end
      else begin
        if (enb) begin
  ...
  HSG_IP_src_horizontalMux u_HORIZONTAL_MULTIPLEXING (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .dataIn1(horDataIn),  // uint8
                                                      .dataIn2(DATA1),  // uint8
                                                      .dataIn3(DATA2),  // uint8
                                                      .unloadSEL(unloadSEL),
                                                      .horMUXSEL(horMUXSELREG),  // ufix2
                                                      .dataOut1(dataHor1),  // uint8
                                                      .dataOut2(dataHor2),  // uint8
                                                      .dataOut3(dataHor3)  // uint8
                                                      );

  HSG_IP_src_verticalMux u_VERTICAL_MULTIPLEXING (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dataIn1(dataHor1),  // uint8
                                                  .dataIn2(dataHor2),  // uint8
                                                  .dataIn3(dataHor3),  // uint8
                                                  .verMuxSEL(verMUXSEL),  // ufix2
                                                  .dataOut1(dataVer1),  // uint8
                                                  .dataOut2(dataVer2),  // uint8
                                                  .dataOut3(dataVer3)  // uint8
                                                  );
...
endmodule  // HSG_IP_src_LineBuffer
