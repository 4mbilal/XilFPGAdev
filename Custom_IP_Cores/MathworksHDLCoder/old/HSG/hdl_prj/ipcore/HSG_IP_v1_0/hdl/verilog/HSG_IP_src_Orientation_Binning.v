// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_Orientation_Binning.v
// Created: 2018-10-21 17:42:57
// 
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_Orientation_Binning
// Source Path: HSG/HSG/Orientation_Binning
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module HSG_IP_src_Orientation_Binning
  ...
  reg signed [10:0] Orientation_Binning_in0_buff_in_pipe_reg [0:2];  // sfix11 [3]
  wire signed [10:0] Orientation_Binning_in0_buff_in_pipe_reg_next [0:2];  // sfix11_En3 [3]
  wire signed [10:0] sobel_gradient_v_1;  // sfix11_En3
  wire signed [21:0] tmp;  // sfix22_En6
  reg signed [10:0] Orientation_Binning_in1_buff_in_pipe_reg [0:2];  // sfix11 [3]
  wire signed [10:0] Orientation_Binning_in1_buff_in_pipe_reg_next [0:2];  // sfix11_En3 [3]
  ...
  always @(posedge clk or posedge reset)
    begin : Orientation_Binning_in0_buff_in_pipe_process
      if (reset == 1'b1) begin
        Orientation_Binning_in0_buff_in_pipe_reg[0] <= 11'sb00000000000;
        Orientation_Binning_in0_buff_in_pipe_reg[1] <= 11'sb00000000000;
        Orientation_Binning_in0_buff_in_pipe_reg[2] <= 11'sb00000000000;
      end
      else begin
        if (enb) begin
          Orientation_Binning_in0_buff_in_pipe_reg[0] <= Orientation_Binning_in0_buff_in_pipe_reg_next[0];
          Orientation_Binning_in0_buff_in_pipe_reg[1] <= Orientation_Binning_in0_buff_in_pipe_reg_next[1];
          Orientation_Binning_in0_buff_in_pipe_reg[2] <= Orientation_Binning_in0_buff_in_pipe_reg_next[2];
        end
      end
    end

  assign sobel_gradient_v_1 = Orientation_Binning_in0_buff_in_pipe_reg[2];
  assign Orientation_Binning_in0_buff_in_pipe_reg_next[0] = sobel_gradient_v;
  assign Orientation_Binning_in0_buff_in_pipe_reg_next[1] = Orientation_Binning_in0_buff_in_pipe_reg[0];
  assign Orientation_Binning_in0_buff_in_pipe_reg_next[2] = Orientation_Binning_in0_buff_in_pipe_reg[1];
  ...
  always @(posedge clk or posedge reset)
    begin : Orientation_Binning_in1_buff_in_pipe_process
      if (reset == 1'b1) begin
        Orientation_Binning_in1_buff_in_pipe_reg[0] <= 11'sb00000000000;
        Orientation_Binning_in1_buff_in_pipe_reg[1] <= 11'sb00000000000;
        Orientation_Binning_in1_buff_in_pipe_reg[2] <= 11'sb00000000000;
      end
      else begin
        if (enb) begin
          Orientation_Binning_in1_buff_in_pipe_reg[0] <= Orientation_Binning_in1_buff_in_pipe_reg_next[0];
          Orientation_Binning_in1_buff_in_pipe_reg[1] <= Orientation_Binning_in1_buff_in_pipe_reg_next[1];
          Orientation_Binning_in1_buff_in_pipe_reg[2] <= Orientation_Binning_in1_buff_in_pipe_reg_next[2];
        end
      end
    end

  assign sobel_gradient_h_1 = Orientation_Binning_in1_buff_in_pipe_reg[2];
  assign Orientation_Binning_in1_buff_in_pipe_reg_next[0] = sobel_gradient_h;
  assign Orientation_Binning_in1_buff_in_pipe_reg_next[1] = Orientation_Binning_in1_buff_in_pipe_reg[0];
  assign Orientation_Binning_in1_buff_in_pipe_reg_next[2] = Orientation_Binning_in1_buff_in_pipe_reg[1];
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_falseregionp27
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_falseregionp41
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_trueregionp41
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_falseregionp37
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_trueregionp37
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_falseregionp33
  assign tmp_23 = (tmp_19 == 1'b0 ? Bin_index_5 :
              Bin_index_7);



  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_trueregionp33
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_falseregionp54
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_trueregionp54
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_falseregionp50
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_trueregionp50
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_falseregionp46
  assign tmp_35 = (tmp_30 == 1'b0 ? Bin_index_14 :
              Bin_index_16);



  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_trueregionp46
  ...
  // HDL code generation from MATLAB function: sf_gateway_Orientation_Binning_trueregionp27
...
endmodule  // HSG_IP_src_Orientation_Binning
