// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_GaussianGyGx.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_GaussianGyGx
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/GaussianGyGx
// Hierarchy Level: 2
// 
// Image Filter
// 
...
module Harris_HW_ip_src_GaussianGyGx
  ...
  input   reset;
  input   enb;
  input   signed [17:0] in0;  // sfix18
  input   in1_hStart;
  input   in1_hEnd;
  input   in1_vStart;
  input   in1_vEnd;
  input   in1_valid;
  output  signed [17:0] out0;  // sfix18
  output  out1_hStart;
  output  out1_hEnd;
  output  out1_vStart;
  output  out1_vEnd;
  ...
  reg signed [17:0] dataInReg;  // sfix18
  reg  hStartInReg;
  reg  hendInReg;
  reg  vStartInReg;
  reg  vendInReg;
  reg  validInReg;
  wire signed [17:0] LMKDataOut_0;  // sfix18
  wire signed [17:0] LMKDataOut_1;  // sfix18
  wire signed [17:0] LMKDataOut_2;  // sfix18
  wire signed [17:0] LMKDataOut_3;  // sfix18
  wire signed [17:0] LMKDataOut_4;  // sfix18
  wire LMKhStartOut;
  wire LMKhEndOut;
  wire LMKvStartOut;
  wire LMKvEndOut;
  wire LMKvalidOut;
  wire LMKprocessOut;
  wire signed [17:0] preFilterDataOut;  // sfix18
  wire prehStartOut;
  wire prehEndOut;
  wire prevStartOut;
  wire prevEndOut;
  wire preValidOut;
  wire signed [17:0] zeroOut_1;  // sfix18
  wire signed [17:0] preDataOut;  // sfix18
  reg signed [17:0] intdelay_reg [0:3];  // sfix18 [4]
  wire signed [17:0] intdelay_reg_next [0:3];  // sfix18 [4]
  wire signed [17:0] dataOut;  // sfix18
  ...
  Harris_HW_ip_src_LineBuffer_block3 u_LineBuffer (.clk(clk),
                                                   .reset(reset),
                                                   .enb(enb),
                                                   .dataIn(dataInReg),  // sfix18
                                                   .hStartIn(hStartInReg),
                                                   .hEndIn(hendInReg),
                                                   .vStartIn(vStartInReg),
                                                   .vEndIn(vendInReg),
                                                   .validIn(validInReg),
                                                   .dataOut_0(LMKDataOut_0),  // sfix18
                                                   .dataOut_1(LMKDataOut_1),  // sfix18
                                                   .dataOut_2(LMKDataOut_2),  // sfix18
                                                   .dataOut_3(LMKDataOut_3),  // sfix18
                                                   .dataOut_4(LMKDataOut_4),  // sfix18
  ...
  Harris_HW_ip_src_FIR2DKernel_block3 u_imagekernel_inst (.clk(clk),
                                                          .reset(reset),
                                                          .enb(enb),
                                                          .dataIn_0(LMKDataOut_0),  // sfix18
                                                          .dataIn_1(LMKDataOut_1),  // sfix18
                                                          .dataIn_2(LMKDataOut_2),  // sfix18
                                                          .dataIn_3(LMKDataOut_3),  // sfix18
                                                          .dataIn_4(LMKDataOut_4),  // sfix18
                                                          ...
                                                          .dataOut(preFilterDataOut),  // sfix18
  ...
  assign zeroOut_1 = 18'sb000000000000000000;
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_process
      if (reset == 1'b1) begin
        ...
        intdelay_reg[3] <= 18'sb000000000000000000;
      end
      else begin
        if (enb) begin
...
endmodule  // Harris_HW_ip_src_GaussianGyGx
