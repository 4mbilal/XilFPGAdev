// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_LineInfoStore_block.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_LineInfoStore_block
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/Gradients/Gradx/LineBuffer/LineInfoStore
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_src_LineInfoStore_block
  ...
  always @(posedge clk or posedge reset)
    begin : alphaSignal_CtxName_CornerDetection_RefNum_s18_UserName_validTemp2_RTTIClass_class_pir_Signal_Network_n71_process
      if (reset == 1'b1) begin
        hEndCentreTap <= 1'b0;
      end
      else begin
...
endmodule  // Harris_HW_ip_src_LineInfoStore_block
