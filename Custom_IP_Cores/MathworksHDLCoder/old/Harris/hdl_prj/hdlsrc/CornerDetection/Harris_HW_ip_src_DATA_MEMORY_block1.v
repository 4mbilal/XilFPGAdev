// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_DATA_MEMORY_block1.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_DATA_MEMORY_block1
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/GaussianGx/LineBuffer/DATA_MEMORY
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_src_DATA_MEMORY_block1
  ...
  Harris_HW_ip_src_PushPopCounterOne_block1 u_PushPopCounterOne (.clk(clk),
                                                                 .reset(reset),
                                                                 .enb(enb),
                                                                 .hStartIn(hStartIn),
                                                                 .popIn(validPop),
  ...
  Harris_HW_ip_src_PushPopCounter_block1 u_PushPopCounter2 (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartIn),
                                                            .popIn(validPop),
  ...
  Harris_HW_ip_src_PushPopCounter_block1 u_PushPopCounter3 (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartIn),
                                                            .popIn(validPop),
  ...
  Harris_HW_ip_src_PushPopCounter_block1 u_PushPopCounter4 (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartIn),
                                                            .popIn(validPop),
...
endmodule  // Harris_HW_ip_src_DATA_MEMORY_block1
