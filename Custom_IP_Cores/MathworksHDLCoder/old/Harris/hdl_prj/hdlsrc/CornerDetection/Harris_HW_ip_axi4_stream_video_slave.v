// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_axi4_stream_video_slave.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_axi4_stream_video_slave
// Source Path: Harris_HW_ip/Harris_HW_ip_axi4_stream_video_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_axi4_stream_video_slave
  ...
  Harris_HW_ip_fifo_eol u_Harris_HW_ip_fifo_eol_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  Harris_HW_ip_fifo_sof u_Harris_HW_ip_fifo_sof_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  Harris_HW_ip_adapter_in u_Harris_HW_ip_Harris_HW_ip_axi4_stream_video_slave_Harris_HW_ip_adapter_in (.clk(clk),
                                                                                                       .reset(reset),
  ...
  Harris_HW_ip_fifo_data u_Harris_HW_ip_fifo_data_inst (.clk(clk),
                                                        .reset(reset),
                                                        .enb(enb),
...
endmodule  // Harris_HW_ip_axi4_stream_video_slave
