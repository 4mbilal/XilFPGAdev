// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_axi4_stream_video_master.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_axi4_stream_video_master
// Source Path: HSG_IP/HSG_IP_axi4_stream_video_master
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module HSG_IP_axi4_stream_video_master
  ...
  HSG_IP_fifo_data_OUT u_HSG_IP_fifo_data_OUT_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
  ...
  HSG_IP_fifo_eol_out u_HSG_IP_fifo_eol_out_inst (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
  ...
  HSG_IP_fifo_sof_out u_HSG_IP_fifo_sof_out_inst (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
...
endmodule  // HSG_IP_axi4_stream_video_master
