// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_Color_Space_Converter.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_Color_Space_Converter
// Source Path: HSG/HSG/Color Space Converter
// Hierarchy Level: 1
// 
...
module HSG_IP_src_Color_Space_Converter
  ...
  HSG_IP_src_RGB2INTENSITY u_rgb2intensityNet_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .R(In1Reg),  // uint8
                                                    .G(In2Reg),  // uint8
...
endmodule  // HSG_IP_src_Color_Space_Converter
