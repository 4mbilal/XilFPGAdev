// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_Image_Filter5.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_Image_Filter5
// Source Path: HSG/HSG/Image Filter5
// Hierarchy Level: 1
// 
// Image Filter
// 
...
module HSG_IP_src_Image_Filter5
  ...
  HSG_IP_src_LineBuffer_block5 u_LineBuffer (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
  ...
  HSG_IP_src_FIR2DKernel_block4 u_imagekernel_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
...
endmodule  // HSG_IP_src_Image_Filter5
