// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_fifo_sof.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_fifo_sof
// Source Path: Harris_HW_ip/Harris_HW_ip_axi4_stream_video_slave/Harris_HW_ip_fifo_sof
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_fifo_sof
  ...
  Harris_HW_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                           ...
                                           u_Harris_HW_ip_fifo_sof_classic_ram (.clk(clk),
                                                                                .enb(enb),
                                                                                .wr_din(In),  // ufix1
                                                                                .wr_addr(w_waddr),
                                                                                .wr_en(w_we),  // ufix1
...
endmodule  // Harris_HW_ip_fifo_sof
