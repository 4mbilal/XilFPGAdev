// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_FIR2DKernel_block.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_FIR2DKernel_block
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/Gradients/Grady/FIR2DKernel
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_1_reg_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          preAdd1_stage1_1 <= tapOutData_3_1;
        end
      end
    end
  ...
  always @(posedge clk or posedge reset)
    begin : preAdd1_stage1_2_reg_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          preAdd1_stage1_2 <= tapOutData_1_1;
        end
      end
    end
...
endmodule  // Harris_HW_ip_src_FIR2DKernel_block
