// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_fifo_data.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_fifo_data
// Source Path: Harris_HW_ip/Harris_HW_ip_axi4_stream_video_slave/Harris_HW_ip_fifo_data
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_fifo_data
  ...
  Harris_HW_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                         ...
                                         u_Harris_HW_ip_fifo_data_classic_ram (.clk(clk),
                                                                               .enb(enb),
                                                                               .wr_din(In),
                                                                               .wr_addr(w_waddr),
                                                                               .wr_en(w_we),  // ufix1
...
endmodule  // Harris_HW_ip_fifo_data
