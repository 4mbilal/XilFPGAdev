// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_DATA_MEMORY_block2.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_DATA_MEMORY_block2
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/GaussianGy/LineBuffer/DATA_MEMORY
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_src_DATA_MEMORY_block2
  ...
  Harris_HW_ip_src_PushPopCounterOne_block2 u_PushPopCounterOne (.clk(clk),
                                                                 .reset(reset),
                                                                 .enb(enb),
                                                                 .hStartIn(hStartIn),
                                                                 .popIn(validPop),
  ...
  Harris_HW_ip_src_PushPopCounter_block2 u_PushPopCounter2 (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartIn),
                                                            .popIn(validPop),
  ...
  Harris_HW_ip_src_PushPopCounter_block2 u_PushPopCounter3 (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartIn),
                                                            .popIn(validPop),
  ...
  Harris_HW_ip_src_PushPopCounter_block2 u_PushPopCounter4 (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .hStartIn(hStartIn),
                                                            .popIn(validPop),
...
endmodule  // Harris_HW_ip_src_DATA_MEMORY_block2
