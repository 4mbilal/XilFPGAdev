// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_fifo_sof_out_classic.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_fifo_sof_out_classic
// Source Path: HSG_IP/HSG_IP_axi4_stream_video_master/HSG_IP_fifo_sof_out/HSG_IP_fifo_sof_out_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module HSG_IP_fifo_sof_out_classic
  ...
  HSG_IP_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                       .DataWidth(1)
                                       )
                                     u_HSG_IP_fifo_sof_out_classic_ram_singlebit (.clk(clk),
                                                                                  .enb(enb),
                                                                                  .wr_din(In),  // ufix1
                                                                                  .wr_addr(w_waddr),
                                                                                  .wr_en(w_we),  // ufix1
...
endmodule  // HSG_IP_fifo_sof_out_classic
