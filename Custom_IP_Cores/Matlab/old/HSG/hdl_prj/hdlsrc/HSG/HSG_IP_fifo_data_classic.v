// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_fifo_data_classic.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_fifo_data_classic
// Source Path: HSG_IP/HSG_IP_axi4_stream_video_slave/HSG_IP_fifo_data/HSG_IP_fifo_data_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module HSG_IP_fifo_data_classic
  ...
  HSG_IP_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                   ...
                                   u_HSG_IP_fifo_data_classic_ram (.clk(clk),
                                                                   .enb(enb),
                                                                   .wr_din(In),
                                                                   .wr_addr(w_waddr),
                                                                   .wr_en(w_we),  // ufix1
...
endmodule  // HSG_IP_fifo_data_classic
