// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_fifo_data_OUT_classic.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_fifo_data_OUT_classic
// Source Path: HSG_IP/HSG_IP_axi4_stream_video_master/HSG_IP_fifo_data_OUT/HSG_IP_fifo_data_OUT_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module HSG_IP_fifo_data_OUT_classic
  ...
  HSG_IP_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                     .DataWidth(32)
                                     )
                                   u_HSG_IP_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                               .enb(enb),
                                                                               .wr_din(In),
                                                                               .wr_addr(w_waddr),
                                                                               .wr_en(w_we),  // ufix1
...
endmodule  // HSG_IP_fifo_data_OUT_classic
