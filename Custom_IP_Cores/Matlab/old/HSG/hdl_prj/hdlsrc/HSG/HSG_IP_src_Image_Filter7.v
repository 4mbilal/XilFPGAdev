// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_Image_Filter7.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_Image_Filter7
// Source Path: HSG/HSG/Image Filter7
// Hierarchy Level: 1
// 
// Image Filter
// 
...
module HSG_IP_src_Image_Filter7
  ...
  HSG_IP_src_LineBuffer_block7 u_LineBuffer (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
  ...
  HSG_IP_src_FIR2DKernel_block6 u_imagekernel_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
...
endmodule  // HSG_IP_src_Image_Filter7
