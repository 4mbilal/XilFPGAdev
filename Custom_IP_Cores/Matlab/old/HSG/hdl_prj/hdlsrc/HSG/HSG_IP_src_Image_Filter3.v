// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_Image_Filter3.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_Image_Filter3
// Source Path: HSG/HSG/Image Filter3
// Hierarchy Level: 1
// 
// Image Filter
// 
...
module HSG_IP_src_Image_Filter3
  ...
  HSG_IP_src_LineBuffer_block3 u_LineBuffer (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
  ...
  HSG_IP_src_FIR2DKernel_block2 u_imagekernel_inst (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
...
endmodule  // HSG_IP_src_Image_Filter3
