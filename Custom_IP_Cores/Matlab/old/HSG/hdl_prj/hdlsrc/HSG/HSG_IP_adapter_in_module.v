// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_adapter_in_module.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_adapter_in_module
// Source Path: HSG_IP/HSG_IP_axi4_stream_video_slave/HSG_IP_adapter_in/HSG_IP_adapter_in_module
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module HSG_IP_adapter_in_module
  ...
  wire equa17_relop1;
  wire [13:0] pixel_counter_sub_1_sub_temp;  // ufix14
  wire [13:0] pixel_counter_sub_1_1;  // ufix14
  wire [13:0] pixel_counter_sub_1_2;  // ufix14
  ...
  assign pixel_counter_sub_1_1 = {1'b0, numofpixels_1};
  assign pixel_counter_sub_1_2 = {13'b0, constant1};
  assign pixel_counter_sub_1_sub_temp = pixel_counter_sub_1_1 - pixel_counter_sub_1_2;
  assign pixel_counter_1 = pixel_counter_sub_1_sub_temp[12:0];
...
endmodule  // HSG_IP_adapter_in_module
