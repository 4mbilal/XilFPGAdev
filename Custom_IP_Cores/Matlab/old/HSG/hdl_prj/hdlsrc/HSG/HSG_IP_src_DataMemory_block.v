// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_DataMemory_block.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_DataMemory_block
// Source Path: HSG/HSG/Image Filter/LineBuffer/DataMemory
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module HSG_IP_src_DataMemory_block
  ...
  HSG_IP_src_PushPopSlicer_block u_SLICER (.pushFIFO(pushFIFO),  // ufix6
  ...
  HSG_IP_src_FIFOLF_block1 u_FIFO1LF (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .LineIn(lineFlagIn1),
                                      .Push(pushIn1),
  ...
  HSG_IP_src_FIFOLineStart_block u_isFIFOLineStart (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .lineFlag(LineIn1),
                                                    .load(load),
  ...
  HSG_IP_src_FIFO_block u_FIFO1 (.clk(clk),
                                 .reset(reset),
                                 .enb(enb),
                                 .dataIn(dataIn),  // ufix1
                                 .Push(pushIn1),
  ...
  HSG_IP_src_advanceFIFO_block u_advanceFIFO (.emptyFlag(emptyFlag1),
                                              .hStart(hStartIn),
  ...
  HSG_IP_src_FIFOLF_block2 u_FIFOLF2 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .LineIn(lineFlagIn2),
  ...
  HSG_IP_src_FIFOLineStart_block u_isFIFOLineStart_1 (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .lineFlag(LineIn2),
                                                      .load(load),
  ...
  HSG_IP_src_FIFO_block u_FIFO2 (.clk(clk),
                                 .reset(reset),
                                 .enb(enb),
  ...
  HSG_IP_src_advanceFIFO_block u_advanceFIFO_1 (.emptyFlag(emptyFlag2),
                                                .hStart(hStartIn),
  ...
  HSG_IP_src_FIFOLF_block2 u_FIFOLF3 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .LineIn(lineFlagIn3),
  ...
  HSG_IP_src_FIFOLineStart_block u_isFIFOLineStart_2 (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .lineFlag(LineIn3),
                                                      .load(load),
  ...
  HSG_IP_src_FIFO_block u_FIFO3 (.clk(clk),
                                 .reset(reset),
                                 .enb(enb),
  ...
  HSG_IP_src_advanceFIFO_block u_advanceFIFO_2 (.emptyFlag(emptyFlag3),
                                                .hStart(hStartIn),
  ...
  HSG_IP_src_FIFOLF_block2 u_FIFOLF4 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .LineIn(lineFlagIn4),
  ...
  HSG_IP_src_FIFOLineStart_block u_isFIFOLineStart_3 (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .lineFlag(LineIn4),
                                                      .load(load),
  ...
  HSG_IP_src_FIFO_block u_FIFO4 (.clk(clk),
                                 .reset(reset),
                                 .enb(enb),
  ...
  HSG_IP_src_advanceFIFO_block u_advanceFIFO_3 (.emptyFlag(emptyFlag4),
                                                .hStart(hStartIn),
  ...
  HSG_IP_src_FIFOLF_block2 u_FIFOLF5 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .LineIn(lineFlagIn5),
  ...
  HSG_IP_src_FIFOLineStart_block u_isFIFOLineStart_4 (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .lineFlag(LineIn5),
                                                      .load(load),
  ...
  HSG_IP_src_FIFO_block u_FIFO5 (.clk(clk),
                                 .reset(reset),
                                 .enb(enb),
  ...
  HSG_IP_src_advanceFIFO_block u_advanceFIFO_4 (.emptyFlag(emptyFlag5),
                                                .hStart(hStartIn),
  ...
  HSG_IP_src_FIFOLF_block2 u_FIFOLF6 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .LineIn(lineFlagIn6),
  ...
  HSG_IP_src_FIFOLineStart_block u_isFIFOLineStart_5 (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .lineFlag(LineIn6),
                                                      .load(load),
  ...
  HSG_IP_src_FIFO_block u_FIFO6 (.clk(clk),
                                 .reset(reset),
                                 .enb(enb),
  ...
  HSG_IP_src_advanceFIFO_block u_advanceFIFO_5 (.emptyFlag(emptyFlag6),
                                                .hStart(hStartIn),
  ...
  HSG_IP_src_unloadLineMask_block u_unloadLineMask (.islineStart1(isLineStart_1),
...
endmodule  // HSG_IP_src_DataMemory_block
