// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_horizontalMux_block3.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_horizontalMux_block3
// Source Path: HSG/HSG/Image Filter3/LineBuffer/horizontalMux
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module HSG_IP_src_horizontalMux_block3
  ...
  HSG_IP_src_horizontalPadder_block3 u_horPAD1 (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
                                                .dataIn(SEL_1),  // ufix1
                                                .horSEL(SEL_4),  // ufix3
  ...
  HSG_IP_src_horizontalPadder_block3 u_horPAD1_1 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dataIn(SEL_6),  // ufix1
                                                  .horSEL(SEL_9),  // ufix3
  ...
  HSG_IP_src_horizontalPadder_block3 u_horPAD1_2 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dataIn(SEL_11),  // ufix1
                                                  .horSEL(SEL_14),  // ufix3
  ...
  HSG_IP_src_horizontalPadder_block3 u_horPAD1_3 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dataIn(SEL_16),  // ufix1
                                                  .horSEL(SEL_19),  // ufix3
  ...
  HSG_IP_src_horizontalPadder_block3 u_horPAD1_4 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dataIn(SEL_21),  // ufix1
                                                  .horSEL(SEL_24),  // ufix3
  ...
  HSG_IP_src_horizontalPadder_block3 u_horPAD1_5 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dataIn(SEL_26),  // ufix1
                                                  .horSEL(SEL_29),  // ufix3
  ...
  HSG_IP_src_horizontalPadder_block3 u_horPAD1_6 (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .dataIn(SEL_31),  // ufix1
                                                  .horSEL(SEL_34),  // ufix3
...
endmodule  // HSG_IP_src_horizontalMux_block3
