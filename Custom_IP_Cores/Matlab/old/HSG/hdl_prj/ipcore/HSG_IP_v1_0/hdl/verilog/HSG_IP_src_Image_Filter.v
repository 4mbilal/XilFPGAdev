// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_Image_Filter.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_Image_Filter
// Source Path: HSG/HSG/Image Filter
// Hierarchy Level: 1
// 
// Image Filter
// 
...
module HSG_IP_src_Image_Filter
  ...
  HSG_IP_src_LineBuffer_block u_LineBuffer (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
  ...
  HSG_IP_src_FIR2DKernel u_imagekernel_inst (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
...
endmodule  // HSG_IP_src_Image_Filter
