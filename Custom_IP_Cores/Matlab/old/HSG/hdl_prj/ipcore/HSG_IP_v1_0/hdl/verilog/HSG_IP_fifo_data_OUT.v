// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_fifo_data_OUT
// Source Path: HSG_IP/HSG_IP_axi4_stream_video_master/HSG_IP_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HSG_IP_fifo_data_OUT
  ...
  HSG_IP_fifo_data_OUT_classic u_HSG_IP_fifo_data_OUT_classic_inst (.clk(clk),
                                                                    .reset(reset),
                                                                    .enb(enb),
                                                                    .In(In),  // ufix32
...
endmodule  // HSG_IP_fifo_data_OUT
