// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP.v
...
module HSG_IP
  ...
  assign ip_timestamp = 32'b01101011111001011010001110011111;
  ...
  HSG_IP_axi_lite u_HSG_IP_axi_lite_inst (.reset(reset),
  ...
  HSG_IP_axi4_stream_video_slave u_HSG_IP_axi4_stream_video_slave_inst (.clk(IPCORE_CLK),  // ufix1
                                                                        .reset(reset),
                                                                        .enb(const_1),
  ...
  HSG_IP_dut u_HSG_IP_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                .reset(reset),
  ...
  HSG_IP_axi4_stream_video_master u_HSG_IP_axi4_stream_video_master_inst (.clk(IPCORE_CLK),  // ufix1
                                                                          .reset(reset),
                                                                          .enb(const_1),
