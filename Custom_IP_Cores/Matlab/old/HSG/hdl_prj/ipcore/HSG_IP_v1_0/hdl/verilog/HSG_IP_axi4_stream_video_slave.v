// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_axi4_stream_video_slave.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_axi4_stream_video_slave
// Source Path: HSG_IP/HSG_IP_axi4_stream_video_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module HSG_IP_axi4_stream_video_slave
  ...
  HSG_IP_fifo_eol u_HSG_IP_fifo_eol_inst (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
  ...
  HSG_IP_fifo_sof u_HSG_IP_fifo_sof_inst (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
  ...
  HSG_IP_adapter_in u_HSG_IP_HSG_IP_axi4_stream_video_slave_HSG_IP_adapter_in (.clk(clk),
                                                                               .reset(reset),
  ...
  HSG_IP_fifo_data u_HSG_IP_fifo_data_inst (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
...
endmodule  // HSG_IP_axi4_stream_video_slave
