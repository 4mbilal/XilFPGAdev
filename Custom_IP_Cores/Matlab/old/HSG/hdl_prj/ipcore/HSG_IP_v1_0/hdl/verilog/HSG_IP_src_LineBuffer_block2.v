// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\HSG\HSG_IP_src_LineBuffer_block2.v
...
// -------------------------------------------------------------
// 
// Module: HSG_IP_src_LineBuffer_block2
// Source Path: HSG/HSG/Image Filter2/LineBuffer
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HSG_IP_src_LineBuffer_block2
  ...
  HSG_IP_src_InputControlValidation_block2 u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                                       .reset(reset),
                                                                       .enb(enb),
                                                                       .hStartIn(hStartIn),
                                                                       .hEndIn(hEndIn),
  ...
  HSG_IP_src_lineSpaceAverager_block2 u_LINE_SPACE_AVERAGER (.clk(clk),
                                                             .reset(reset),
                                                             .enb(enb),
  ...
  HSG_IP_src_lineSpaceStore_block2 u_LINE_SPACE_STORE (.clk(clk),
                                                       .reset(reset),
                                                       .enb(enb),
  ...
  HSG_IP_src_dataReadFSM_block2 u_DATA_READ_FSM (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  HSG_IP_src_DataMemory_block2 u_DATA_MEMORY (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
  ...
  HSG_IP_src_FIFOHandlerFSM_block2 u_FIFO_HANDLER (.clk(clk),
                                                   .reset(reset),
                                                   .enb(enb),
                                                   .allLineStart(allLineStart),
                                                   .hStartIn(hStartD),
  ...
  HSG_IP_src_controlCache_block2 u_CONTROL_CACHE (.clk(clk),
                                                  .reset(reset),
                                                  .enb(enb),
                                                  .hStartIn(hStartIn_1),
                                                  .hEndIn(hEndIn_1),
  ...
  HSG_IP_src_validPipeline_block2 u_VALID_PIPELINE (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .validIn(validS),
  ...
  HSG_IP_src_dataWriteFSM_block2 u_DATA_WRITE_FSM (.clk(clk),
                                                   .reset(reset),
                                                   .enb(enb),
  ...
  HSG_IP_src_horizontalMux_block2 u_HORIZONTAL_MULTIPLEXING (.clk(clk),
                                                             .reset(reset),
                                                             .enb(enb),
  ...
  HSG_IP_src_verticalMux_block2 u_VERTICAL_MULTIPLEXING (.clk(clk),
                                                         .reset(reset),
                                                         .enb(enb),
...
endmodule  // HSG_IP_src_LineBuffer_block2
