#ifndef __HSG_sfun_h__
#define __HSG_sfun_h__
...
extern uint32_T _HSGMachineNumber_;
...
extern mxArray* load_HSG_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_HSG_optimization_info(void);
