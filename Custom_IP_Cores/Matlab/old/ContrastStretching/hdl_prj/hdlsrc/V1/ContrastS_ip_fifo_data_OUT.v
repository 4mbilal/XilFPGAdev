// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_fifo_data_OUT
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_master/ContrastS_ip_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module ContrastS_ip_fifo_data_OUT
  ...
  ContrastS_ip_fifo_data_OUT_classic u_ContrastS_ip_fifo_data_OUT_classic_inst (.clk(clk),
                                                                                .reset(reset),
                                                                                .enb(enb),
                                                                                .In(In),  // ufix32
...
endmodule  // ContrastS_ip_fifo_data_OUT
