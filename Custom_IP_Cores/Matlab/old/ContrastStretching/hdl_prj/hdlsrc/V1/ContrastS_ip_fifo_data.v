// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_fifo_data.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_fifo_data
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_slave/ContrastS_ip_fifo_data
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module ContrastS_ip_fifo_data
  ...
  ContrastS_ip_fifo_data_classic u_ContrastS_ip_fifo_data_classic_inst (.clk(clk),
                                                                        .reset(reset),
                                                                        .enb(enb),
                                                                        .In(In),  // ufix32
...
endmodule  // ContrastS_ip_fifo_data
