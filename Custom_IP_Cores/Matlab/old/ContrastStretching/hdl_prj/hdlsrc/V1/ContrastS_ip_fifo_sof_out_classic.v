// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_fifo_sof_out_classic.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_fifo_sof_out_classic
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_master/ContrastS_ip_fifo_sof_out/ContrastS_ip_fifo_sof_out_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module ContrastS_ip_fifo_sof_out_classic
  ...
  ContrastS_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                             .DataWidth(1)
                                             )
                                           u_ContrastS_ip_fifo_sof_out_classic_ram_singlebit (.clk(clk),
                                                                                              .enb(enb),
                                                                                              .wr_din(In),  // ufix1
                                                                                              .wr_addr(w_waddr),
                                                                                              .wr_en(w_we),  // ufix1
...
endmodule  // ContrastS_ip_fifo_sof_out_classic
