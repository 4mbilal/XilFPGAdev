// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_fifo_data_OUT_classic.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_fifo_data_OUT_classic
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_master/ContrastS_ip_fifo_data_OUT/ContrastS_ip_fifo_data_OUT_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module ContrastS_ip_fifo_data_OUT_classic
  ...
  ContrastS_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                           .DataWidth(32)
                                           )
                                         u_ContrastS_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                           .enb(enb),
                                                                                           .wr_din(In),
                                                                                           .wr_addr(w_waddr),
                                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // ContrastS_ip_fifo_data_OUT_classic
