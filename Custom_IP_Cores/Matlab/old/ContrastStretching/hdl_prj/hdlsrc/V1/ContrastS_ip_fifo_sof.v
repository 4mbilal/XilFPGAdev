// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_fifo_sof.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_fifo_sof
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_slave/ContrastS_ip_fifo_sof
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module ContrastS_ip_fifo_sof
  ...
  ContrastS_ip_fifo_sof_classic u_ContrastS_ip_fifo_sof_classic_inst (.clk(clk),
                                                                      .reset(reset),
                                                                      .enb(enb),
                                                                      .In(In),  // ufix1
...
endmodule  // ContrastS_ip_fifo_sof
