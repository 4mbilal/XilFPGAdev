// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_fifo_data_classic.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_fifo_data_classic
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_slave/ContrastS_ip_fifo_data/ContrastS_ip_fifo_data_classic
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module ContrastS_ip_fifo_data_classic
  ...
  ContrastS_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                         ...
                                         u_ContrastS_ip_fifo_data_classic_ram (.clk(clk),
                                                                               .enb(enb),
                                                                               .wr_din(In),
                                                                               .wr_addr(w_waddr),
                                                                               .wr_en(w_we),  // ufix1
...
endmodule  // ContrastS_ip_fifo_data_classic
