// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_axi4_stream_video_master.v
// Created: 2018-12-04 11:53:21
// 
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_axi4_stream_video_master
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_master
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module ContrastS_ip_axi4_stream_video_master
  ...
  ContrastS_ip_fifo_data_OUT u_ContrastS_ip_fifo_data_OUT_inst (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
  ...
  ContrastS_ip_fifo_eol_out u_ContrastS_ip_fifo_eol_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
  ...
  ContrastS_ip_fifo_sof_out u_ContrastS_ip_fifo_sof_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
...
endmodule  // ContrastS_ip_axi4_stream_video_master
