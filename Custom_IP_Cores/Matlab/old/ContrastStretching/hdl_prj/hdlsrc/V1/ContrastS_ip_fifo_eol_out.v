// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_fifo_eol_out.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_fifo_eol_out
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_master/ContrastS_ip_fifo_eol_out
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module ContrastS_ip_fifo_eol_out
  ...
  ContrastS_ip_fifo_eol_out_classic u_ContrastS_ip_fifo_eol_out_classic_inst (.clk(clk),
                                                                              .reset(reset),
                                                                              .enb(enb),
                                                                              .In(In),  // ufix1
...
endmodule  // ContrastS_ip_fifo_eol_out
