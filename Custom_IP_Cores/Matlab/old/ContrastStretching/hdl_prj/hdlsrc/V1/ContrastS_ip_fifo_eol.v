// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\V1\ContrastS_ip_fifo_eol.v
...
// -------------------------------------------------------------
// 
// Module: ContrastS_ip_fifo_eol
// Source Path: ContrastS_ip/ContrastS_ip_axi4_stream_video_slave/ContrastS_ip_fifo_eol
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module ContrastS_ip_fifo_eol
  ...
  ContrastS_ip_fifo_eol_classic u_ContrastS_ip_fifo_eol_classic_inst (.clk(clk),
                                                                      .reset(reset),
                                                                      .enb(enb),
                                                                      .In(In),  // ufix1
...
endmodule  // ContrastS_ip_fifo_eol
