// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_fifo_sof_out.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_fifo_sof_out
// Source Path: Harris_HW_ip/Harris_HW_ip_axi4_stream_video_master/Harris_HW_ip_fifo_sof_out
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_fifo_sof_out
  ...
  Harris_HW_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                             .DataWidth(1)
                                             )
                                           u_Harris_HW_ip_fifo_sof_out_classic_ram_singlebit (.clk(clk),
                                                                                              .enb(enb),
                                                                                              .wr_din(In),  // ufix1
                                                                                              .wr_addr(w_waddr),
                                                                                              .wr_en(w_we),  // ufix1
...
endmodule  // Harris_HW_ip_fifo_sof_out
