// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_LineBuffer.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_LineBuffer
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/Gradients/Gradx/LineBuffer
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_src_LineBuffer
  ...
  Harris_HW_ip_src_InputControlValidation u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                                      .reset(reset),
                                                                      .enb(enb),
                                                                      .hStartIn(hStartInD),
                                                                      .hEndIn(hEndInD),
  ...
  Harris_HW_ip_src_LineSpaceAverager u_LineSpaceAverager (.clk(clk),
                                                          .reset(reset),
                                                          .enb(enb),
  ...
  Harris_HW_ip_src_DATA_MEMORY u_DATA_MEMORY (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
                                              .Unloading(unloading),
  ...
  Harris_HW_ip_src_LineInfoStore u_LINE_INFO_STORE (.clk(clk),
                                                    .reset(reset),
                                                    .enb(enb),
                                                    .hStartIn(hStartDRC),
                                                    .Unloading(unloading),
  ...
  Harris_HW_ip_src_DataReadController u_DATA_READ_CONTROLLER (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
                                                              .hStartIn(hStartVREG),
                                                              .hEndIn(hEndV_1),
  ...
  Harris_HW_ip_src_LineInfoStore_block u_State_Transition_Flag_Gen (.clk(clk),
                                                                    .reset(reset),
                                                                    .enb(enb),
                                                                    .hStartIn(hStartDRC),
                                                                    .hEndIn(hEndRDT),
  ...
  Harris_HW_ip_src_PaddingController u_Padding_Controller (.clk(clk),
                                                           .reset(reset),
                                                           .enb(enb),
                                                           .PrePadFlag(PrePadFlag),
                                                           .OnLineFlag(OnLineFlag),
  ...
  Harris_HW_ip_src_GateProcessData u_Gate_Process_Data (.clk(clk),
                                                        .reset(reset),
                                                        .enb(enb),
  ...
  Harris_HW_ip_src_Horizontal_Padder u_Horizontal_Padder (.clk(clk),
                                                          .reset(reset),
                                                          .enb(enb),
  ...
  Harris_HW_ip_src_Vertical_Padding_Counter u_Vertical_Counter (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
                                                                .frameEnd(vStartIn),
                                                                .unloading(unloading),
  ...
  Harris_HW_ip_src_Vertical_Padder u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // uint8
...
endmodule  // Harris_HW_ip_src_LineBuffer
