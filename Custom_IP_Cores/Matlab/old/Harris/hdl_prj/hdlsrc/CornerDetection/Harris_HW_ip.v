// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip.v
...
module Harris_HW_ip
  ...
  assign ip_timestamp = 32'b01110111010001110010010010011001;
  ...
  Harris_HW_ip_reset_sync u_Harris_HW_ip_reset_sync_inst (.clk(IPCORE_CLK),  // ufix1
                                                          .reset_in(reset_before_sync),  // ufix1
                                                          .reset_out(reset)
                                                          );

  Harris_HW_ip_axi_lite u_Harris_HW_ip_axi_lite_inst (.reset(reset),
  ...
  Harris_HW_ip_axi4_stream_video_slave u_Harris_HW_ip_axi4_stream_video_slave_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                    .reset(reset),
                                                                                    .enb(const_1),
  ...
  Harris_HW_ip_dut u_Harris_HW_ip_dut_inst (.clk(IPCORE_CLK),  // ufix1
                                            .reset(reset),
  ...
  Harris_HW_ip_axi4_stream_video_master u_Harris_HW_ip_axi4_stream_video_master_inst (.clk(IPCORE_CLK),  // ufix1
                                                                                      .reset(reset),
                                                                                      .enb(const_1),
