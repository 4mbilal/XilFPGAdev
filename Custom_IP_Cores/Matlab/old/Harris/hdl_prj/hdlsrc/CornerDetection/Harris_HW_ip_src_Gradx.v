// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_Gradx.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_Gradx
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/Gradients/Gradx
// Hierarchy Level: 3
// 
// Image Filter
// 
...
module Harris_HW_ip_src_Gradx
  ...
  Harris_HW_ip_src_LineBuffer u_LineBuffer (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
  ...
  Harris_HW_ip_src_FIR2DKernel u_imagekernel_inst (.clk(clk),
                                                   .reset(reset),
                                                   .enb(enb),
...
endmodule  // Harris_HW_ip_src_Gradx
