// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_GaussianGy.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_GaussianGy
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/GaussianGy
// Hierarchy Level: 2
// 
// Image Filter
// 
...
module Harris_HW_ip_src_GaussianGy
  ...
  Harris_HW_ip_src_LineBuffer_block2 u_LineBuffer (.clk(clk),
                                                   .reset(reset),
                                                   .enb(enb),
  ...
  Harris_HW_ip_src_FIR2DKernel_block2 u_imagekernel_inst (.clk(clk),
                                                          .reset(reset),
                                                          .enb(enb),
...
endmodule  // Harris_HW_ip_src_GaussianGy
