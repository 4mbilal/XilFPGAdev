// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_LineBuffer_block1.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_LineBuffer_block1
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/GaussianGx/LineBuffer
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_src_LineBuffer_block1
  ...
  Harris_HW_ip_src_InputControlValidation_block1 u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                                             .reset(reset),
                                                                             .enb(enb),
                                                                             .hStartIn(hStartInD),
                                                                             .hEndIn(hEndInD),
  ...
  Harris_HW_ip_src_LineSpaceAverager_block1 u_LineSpaceAverager (.clk(clk),
                                                                 .reset(reset),
                                                                 .enb(enb),
  ...
  Harris_HW_ip_src_DATA_MEMORY_block1 u_DATA_MEMORY (.clk(clk),
                                                     .reset(reset),
                                                     .enb(enb),
                                                     .Unloading(unloading),
  ...
  Harris_HW_ip_src_LineInfoStore_block3 u_LINE_INFO_STORE (.clk(clk),
                                                           .reset(reset),
                                                           .enb(enb),
                                                           .hStartIn(hStartDRC),
                                                           .Unloading(unloading),
  ...
  Harris_HW_ip_src_DataReadController_block1 u_DATA_READ_CONTROLLER (.clk(clk),
                                                                     .reset(reset),
                                                                     .enb(enb),
                                                                     .hStartIn(hStartVREG),
                                                                     .hEndIn(hEndV_1),
  ...
  Harris_HW_ip_src_LineInfoStore_block4 u_State_Transition_Flag_Gen (.clk(clk),
                                                                     .reset(reset),
                                                                     .enb(enb),
                                                                     .hStartIn(hStartDRC),
                                                                     .hEndIn(hEndRDT),
  ...
  Harris_HW_ip_src_PaddingController_block1 u_Padding_Controller (.clk(clk),
                                                                  .reset(reset),
                                                                  .enb(enb),
                                                                  .PrePadFlag(PrePadFlag),
                                                                  .OnLineFlag(OnLineFlag),
  ...
  Harris_HW_ip_src_GateProcessData_block1 u_Gate_Process_Data (.clk(clk),
                                                               .reset(reset),
                                                               .enb(enb),
  ...
  Harris_HW_ip_src_Horizontal_Padder_block1 u_Horizontal_Padder (.clk(clk),
                                                                 .reset(reset),
                                                                 .enb(enb),
  ...
  Harris_HW_ip_src_Vertical_Padding_Counter_block1 u_Vertical_Counter (.clk(clk),
                                                                       .reset(reset),
                                                                       .enb(enb),
                                                                       .frameEnd(vStartIn),
                                                                       .unloading(unloading),
  ...
  Harris_HW_ip_src_Vertical_Padder_block1 u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // sfix18
...
endmodule  // Harris_HW_ip_src_LineBuffer_block1
