// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_fifo_data_OUT.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_fifo_data_OUT
// Source Path: Harris_HW_ip/Harris_HW_ip_axi4_stream_video_master/Harris_HW_ip_fifo_data_OUT
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_fifo_data_OUT
  ...
  Harris_HW_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                           .DataWidth(32)
                                           )
                                         u_Harris_HW_ip_fifo_data_OUT_classic_ram_generic (.clk(clk),
                                                                                           .enb(enb),
                                                                                           .wr_din(In),
                                                                                           .wr_addr(w_waddr),
                                                                                           .wr_en(w_we),  // ufix1
...
endmodule  // Harris_HW_ip_fifo_data_OUT
