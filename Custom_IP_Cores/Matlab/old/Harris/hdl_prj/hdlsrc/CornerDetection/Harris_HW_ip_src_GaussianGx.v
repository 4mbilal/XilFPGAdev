// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_GaussianGx.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_GaussianGx
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/GaussianGx
// Hierarchy Level: 2
// 
// Image Filter
// 
...
module Harris_HW_ip_src_GaussianGx
  ...
  Harris_HW_ip_src_LineBuffer_block1 u_LineBuffer (.clk(clk),
                                                   .reset(reset),
                                                   .enb(enb),
  ...
  Harris_HW_ip_src_FIR2DKernel_block1 u_imagekernel_inst (.clk(clk),
                                                          .reset(reset),
                                                          .enb(enb),
...
endmodule  // Harris_HW_ip_src_GaussianGx
