// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_DATA_MEMORY_block.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_DATA_MEMORY_block
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/Gradients/Grady/LineBuffer/DATA_MEMORY
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_src_DATA_MEMORY_block
  ...
  Harris_HW_ip_src_PushPopCounterOne_block u_PushPopCounterOne (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
                                                                .hStartIn(hStartIn),
                                                                .popIn(validPop),
  ...
  Harris_HW_ip_src_PushPopCounter_block u_PushPopCounter2 (.clk(clk),
                                                           .reset(reset),
                                                           .enb(enb),
                                                           .hStartIn(hStartIn),
                                                           .popIn(validPop),
...
endmodule  // Harris_HW_ip_src_DATA_MEMORY_block
