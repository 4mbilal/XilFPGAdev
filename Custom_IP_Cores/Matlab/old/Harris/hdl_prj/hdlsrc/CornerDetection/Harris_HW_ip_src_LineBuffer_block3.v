// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_LineBuffer_block3.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_LineBuffer_block3
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/GaussianGyGx/LineBuffer
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_src_LineBuffer_block3
  ...
  input   reset;
  input   enb;
  input   signed [17:0] dataIn;  // sfix18
  input   hStartIn;
  input   hEndIn;
  input   vStartIn;
  input   vEndIn;
  input   validIn;
  output  signed [17:0] dataOut_0;  // sfix18
  output  signed [17:0] dataOut_1;  // sfix18
  output  signed [17:0] dataOut_2;  // sfix18
  output  signed [17:0] dataOut_3;  // sfix18
  output  signed [17:0] dataOut_4;  // sfix18
  output  hStartOut;
  output  hEndOut;
  output  vStartOut;
  output  vEndOut;
  ...
  reg signed [17:0] intdelay_reg_6 [0:3];  // sfix18 [4]
  wire signed [17:0] intdelay_reg_next_6 [0:3];  // sfix18 [4]
  wire signed [17:0] dataInREG;  // sfix18
  ...
  reg  hStartDRC;
  reg  vEndRREG;
  wire signed [17:0] DataMemVector_0;  // sfix18
  wire signed [17:0] DataMemVector_1;  // sfix18
  wire signed [17:0] DataMemVector_2;  // sfix18
  wire signed [17:0] DataMemVector_3;  // sfix18
  wire signed [17:0] DataMemVector_4;  // sfix18
  wire popReg;
  wire AllEndOfLine;
  reg  AllEndOfLineREG;
  wire vEndR;
  ...
  wire Running;
  reg  outputDataREG;
  wire signed [17:0] constZero [0:4];  // sfix18 [5]
  wire runOrUnload;
  ...
  wire outputProcess;
  wire padShift;
  wire signed [17:0] DataMemVector [0:4];  // sfix18 [5]
  reg signed [17:0] intdelay_reg_9 [0:4];  // sfix18 [5]
  wire signed [17:0] intdelay_reg_next_9 [0:4];  // sfix18 [5]
  wire signed [17:0] DataMemVectorREG [0:4];  // sfix18 [5]
  wire countEnHC_1;
  reg [9:0] horPadCount;  // ufix10
  reg [9:0] horPadCountREG;  // ufix10
  wire signed [17:0] DataMemVectorPadded_0;  // sfix18
  wire signed [17:0] DataMemVectorPadded_1;  // sfix18
  wire signed [17:0] DataMemVectorPadded_2;  // sfix18
  wire signed [17:0] DataMemVectorPadded_3;  // sfix18
  wire signed [17:0] DataMemVectorPadded_4;  // sfix18
  wire [9:0] VerCountOut;  // ufix10
  wire signed [17:0] verPadOut_0;  // sfix18
  wire signed [17:0] verPadOut_1;  // sfix18
  wire signed [17:0] verPadOut_2;  // sfix18
  wire signed [17:0] verPadOut_3;  // sfix18
  wire signed [17:0] verPadOut_4;  // sfix18
  wire signed [17:0] verPadOut [0:4];  // sfix18 [5]
  reg signed [17:0] reg_reg [0:4];  // sfix18 [5]
  wire signed [17:0] reg_reg_next [0:4];  // sfix18 [5]
  wire signed [17:0] verPadD [0:4];  // sfix18 [5]
  wire signed [17:0] dataSigOut [0:4];  // sfix18 [5]
  reg signed [17:0] reg_reg_1 [0:4];  // sfix18 [5]
  wire signed [17:0] reg_reg_next_1 [0:4];  // sfix18 [5]
  wire signed [17:0] dataSigPreOD [0:4];  // sfix18 [5]
  wire signed [17:0] dataOut [0:4];  // sfix18 [5]
  wire ctrlOutZero;
  ...
  Harris_HW_ip_src_InputControlValidation_block3 u_INPUT_CONTROL_VALIDATION (.clk(clk),
                                                                             .reset(reset),
                                                                             .enb(enb),
                                                                             .hStartIn(hStartInD),
                                                                             .hEndIn(hEndInD),
  ...
  Harris_HW_ip_src_LineSpaceAverager_block3 u_LineSpaceAverager (.clk(clk),
                                                                 .reset(reset),
                                                                 .enb(enb),
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_6_process
      if (reset == 1'b1) begin
        intdelay_reg_6[0] <= 18'sb000000000000000000;
        intdelay_reg_6[1] <= 18'sb000000000000000000;
        intdelay_reg_6[2] <= 18'sb000000000000000000;
        intdelay_reg_6[3] <= 18'sb000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  Harris_HW_ip_src_DATA_MEMORY_block3 u_DATA_MEMORY (.clk(clk),
                                                     .reset(reset),
                                                     .enb(enb),
                                                     .Unloading(unloading),
                                                     .pixelIn(dataInREG),  // sfix18
                                                     .hStartIn(hStartDRC),
                                                     .hEndIn(hEndRREG),
                                                     .vStartIn(vStartDRC),
                                                     .vEndIn(vEndRREG),
                                                     .validIn(validRREG),
                                                     .popEn(popEn),  // ufix2
                                                     .dataVectorOut_0(DataMemVector_0),  // sfix18
                                                     .dataVectorOut_1(DataMemVector_1),  // sfix18
                                                     .dataVectorOut_2(DataMemVector_2),  // sfix18
                                                     .dataVectorOut_3(DataMemVector_3),  // sfix18
                                                     .dataVectorOut_4(DataMemVector_4),  // sfix18
                                                     .popOut(popReg),
  ...
  Harris_HW_ip_src_LineInfoStore_block7 u_LINE_INFO_STORE (.clk(clk),
                                                           .reset(reset),
                                                           .enb(enb),
                                                           .hStartIn(hStartDRC),
                                                           .Unloading(unloading),
  ...
  Harris_HW_ip_src_DataReadController_block3 u_DATA_READ_CONTROLLER (.clk(clk),
                                                                     .reset(reset),
                                                                     .enb(enb),
                                                                     .hStartIn(hStartVREG),
                                                                     .hEndIn(hEndV_1),
  ...
  assign constZero[0] = 18'sb000000000000000000;
  assign constZero[1] = 18'sb000000000000000000;
  assign constZero[2] = 18'sb000000000000000000;
  assign constZero[3] = 18'sb000000000000000000;
  assign constZero[4] = 18'sb000000000000000000;
  ...
  Harris_HW_ip_src_LineInfoStore_block8 u_State_Transition_Flag_Gen (.clk(clk),
                                                                     .reset(reset),
                                                                     .enb(enb),
                                                                     .hStartIn(hStartDRC),
                                                                     .hEndIn(hEndRDT),
  ...
  Harris_HW_ip_src_PaddingController_block3 u_Padding_Controller (.clk(clk),
                                                                  .reset(reset),
                                                                  .enb(enb),
                                                                  .PrePadFlag(PrePadFlag),
                                                                  .OnLineFlag(OnLineFlag),
  ...
  Harris_HW_ip_src_GateProcessData_block3 u_Gate_Process_Data (.clk(clk),
                                                               .reset(reset),
                                                               .enb(enb),
  ...
  always @(posedge clk or posedge reset)
    begin : intdelay_9_process
      if (reset == 1'b1) begin
        intdelay_reg_9[0] <= 18'sb000000000000000000;
        intdelay_reg_9[1] <= 18'sb000000000000000000;
        intdelay_reg_9[2] <= 18'sb000000000000000000;
        intdelay_reg_9[3] <= 18'sb000000000000000000;
        intdelay_reg_9[4] <= 18'sb000000000000000000;
      end
      else begin
  ...
  Harris_HW_ip_src_Horizontal_Padder_block3 u_Horizontal_Padder (.clk(clk),
                                                                 .reset(reset),
                                                                 .enb(enb),
                                                                 .dataVectorIn_0(DataMemVectorREG[0]),  // sfix18
                                                                 .dataVectorIn_1(DataMemVectorREG[1]),  // sfix18
                                                                 .dataVectorIn_2(DataMemVectorREG[2]),  // sfix18
                                                                 .dataVectorIn_3(DataMemVectorREG[3]),  // sfix18
                                                                 .dataVectorIn_4(DataMemVectorREG[4]),  // sfix18
                                                                 .horPadCount(horPadCountREG),  // ufix10
                                                                 .padShift(padShift),
                                                                 .dataVector_0(DataMemVectorPadded_0),  // sfix18
                                                                 .dataVector_1(DataMemVectorPadded_1),  // sfix18
                                                                 .dataVector_2(DataMemVectorPadded_2),  // sfix18
                                                                 .dataVector_3(DataMemVectorPadded_3),  // sfix18
                                                                 .dataVector_4(DataMemVectorPadded_4)  // sfix18
                                                                 );

  Harris_HW_ip_src_Vertical_Padding_Counter_block3 u_Vertical_Counter (.clk(clk),
                                                                       .reset(reset),
                                                                       .enb(enb),
                                                                       .frameEnd(vStartIn),
                                                                       .unloading(unloading),
  ...
  Harris_HW_ip_src_Vertical_Padder_block3 u_Vertical_Padder (.dataVectorIn_0(DataMemVectorPadded_0),  // sfix18
                                                             .dataVectorIn_1(DataMemVectorPadded_1),  // sfix18
                                                             .dataVectorIn_2(DataMemVectorPadded_2),  // sfix18
                                                             .dataVectorIn_3(DataMemVectorPadded_3),  // sfix18
                                                             .dataVectorIn_4(DataMemVectorPadded_4),  // sfix18
                                                             .verPadCount(VerCountOut),  // ufix10
                                                             .dataVectorOut_0(verPadOut_0),  // sfix18
                                                             .dataVectorOut_1(verPadOut_1),  // sfix18
                                                             .dataVectorOut_2(verPadOut_2),  // sfix18
                                                             .dataVectorOut_3(verPadOut_3),  // sfix18
                                                             .dataVectorOut_4(verPadOut_4)  // sfix18
                                                             );
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_14_process
      if (reset == 1'b1) begin
        reg_reg[0] <= 18'sb000000000000000000;
        reg_reg[1] <= 18'sb000000000000000000;
        reg_reg[2] <= 18'sb000000000000000000;
        reg_reg[3] <= 18'sb000000000000000000;
        reg_reg[4] <= 18'sb000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : reg_rsvd_15_process
      if (reset == 1'b1) begin
        reg_reg_1[0] <= 18'sb000000000000000000;
        reg_reg_1[1] <= 18'sb000000000000000000;
        reg_reg_1[2] <= 18'sb000000000000000000;
        reg_reg_1[3] <= 18'sb000000000000000000;
        reg_reg_1[4] <= 18'sb000000000000000000;
      end
      else begin
        if (enb) begin
...
endmodule  // Harris_HW_ip_src_LineBuffer_block3
