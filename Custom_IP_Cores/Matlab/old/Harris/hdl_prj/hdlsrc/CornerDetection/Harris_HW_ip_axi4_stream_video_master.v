// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_axi4_stream_video_master.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_axi4_stream_video_master
// Source Path: Harris_HW_ip/Harris_HW_ip_axi4_stream_video_master
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Harris_HW_ip_axi4_stream_video_master
  ...
  Harris_HW_ip_fifo_data_OUT u_Harris_HW_ip_fifo_data_OUT_inst (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
  ...
  Harris_HW_ip_fifo_eol_out u_Harris_HW_ip_fifo_eol_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
  ...
  Harris_HW_ip_fifo_sof_out u_Harris_HW_ip_fifo_sof_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
...
endmodule  // Harris_HW_ip_axi4_stream_video_master
