// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\CornerDetection\Harris_HW_ip_src_RGB2INTENSITY.v
...
// -------------------------------------------------------------
// 
// Module: Harris_HW_ip_src_RGB2INTENSITY
// Source Path: CornerDetection/Harris_HW/HDL Corner Algorithm/RGB2Bin/Color Space Converter/RGB2INTENSITY
// Hierarchy Level: 4
// 
...
module Harris_HW_ip_src_RGB2INTENSITY
  ...
  assign castout = ((S2_delay[25:24] != 2'b00) || ((S2_delay[25] == 1'b0) && (S2_delay[23:16] == 8'b11111111)) ? 8'b11111111 :
...
endmodule  // Harris_HW_ip_src_RGB2INTENSITY
