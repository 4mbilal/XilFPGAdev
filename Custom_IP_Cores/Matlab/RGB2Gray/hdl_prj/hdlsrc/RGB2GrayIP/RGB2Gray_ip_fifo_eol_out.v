// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\RGB2GrayIP\RGB2Gray_ip_fifo_eol_out.v
...
// -------------------------------------------------------------
// 
// Module: RGB2Gray_ip_fifo_eol_out
// Source Path: RGB2Gray_ip/RGB2Gray_ip_axi4_stream_video_master/RGB2Gray_ip_fifo_eol_out
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RGB2Gray_ip_fifo_eol_out
  ...
  RGB2Gray_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                          ...
                                          u_RGB2Gray_ip_fifo_eol_out_classic_ram (.clk(clk),
                                                                                  .enb(enb),
                                                                                  .wr_din(In),  // ufix1
                                                                                  .wr_addr(w_waddr),
                                                                                  .wr_en(w_we),  // ufix1
...
endmodule  // RGB2Gray_ip_fifo_eol_out
