// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\RGB2GrayIP\RGB2Gray_ip_fifo_data.v
...
// -------------------------------------------------------------
// 
// Module: RGB2Gray_ip_fifo_data
// Source Path: RGB2Gray_ip/RGB2Gray_ip_axi4_stream_video_slave/RGB2Gray_ip_fifo_data
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RGB2Gray_ip_fifo_data
  ...
  RGB2Gray_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                        ...
                                        u_RGB2Gray_ip_fifo_data_classic_ram (.clk(clk),
                                                                             .enb(enb),
                                                                             .wr_din(In),
                                                                             .wr_addr(w_waddr),
                                                                             .wr_en(w_we),  // ufix1
...
endmodule  // RGB2Gray_ip_fifo_data
