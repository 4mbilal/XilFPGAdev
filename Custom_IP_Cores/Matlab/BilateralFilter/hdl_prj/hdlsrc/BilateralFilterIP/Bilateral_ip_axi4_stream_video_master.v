// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BilateralFilterIP\Bilateral_ip_axi4_stream_video_master.v
...
// -------------------------------------------------------------
// 
// Module: Bilateral_ip_axi4_stream_video_master
// Source Path: Bilateral_ip/Bilateral_ip_axi4_stream_video_master
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Bilateral_ip_axi4_stream_video_master
  ...
  Bilateral_ip_fifo_data_OUT u_Bilateral_ip_fifo_data_OUT_inst (.clk(clk),
                                                                .reset(reset),
                                                                .enb(enb),
  ...
  Bilateral_ip_fifo_eol_out u_Bilateral_ip_fifo_eol_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
  ...
  Bilateral_ip_fifo_sof_out u_Bilateral_ip_fifo_sof_out_inst (.clk(clk),
                                                              .reset(reset),
                                                              .enb(enb),
...
endmodule  // Bilateral_ip_axi4_stream_video_master
