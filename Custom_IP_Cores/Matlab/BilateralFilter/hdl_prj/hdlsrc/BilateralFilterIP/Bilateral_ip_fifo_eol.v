// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BilateralFilterIP\Bilateral_ip_fifo_eol.v
...
// -------------------------------------------------------------
// 
// Module: Bilateral_ip_fifo_eol
// Source Path: Bilateral_ip/Bilateral_ip_axi4_stream_video_slave/Bilateral_ip_fifo_eol
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Bilateral_ip_fifo_eol
  ...
  Bilateral_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                           ...
                                           u_Bilateral_ip_fifo_eol_classic_ram (.clk(clk),
                                                                                .enb(enb),
                                                                                .wr_din(In),  // ufix1
                                                                                .wr_addr(w_waddr),
                                                                                .wr_en(w_we),  // ufix1
...
endmodule  // Bilateral_ip_fifo_eol
