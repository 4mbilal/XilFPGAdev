// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BilateralFilterIP\Bilateral_ip_axi4_stream_video_slave.v
...
// -------------------------------------------------------------
// 
// Module: Bilateral_ip_axi4_stream_video_slave
// Source Path: Bilateral_ip/Bilateral_ip_axi4_stream_video_slave
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Bilateral_ip_axi4_stream_video_slave
  ...
  Bilateral_ip_fifo_eol u_Bilateral_ip_fifo_eol_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  Bilateral_ip_fifo_sof u_Bilateral_ip_fifo_sof_inst (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
  ...
  Bilateral_ip_adapter_in u_Bilateral_ip_Bilateral_ip_axi4_stream_video_slave_Bilateral_ip_adapter_in (.clk(clk),
                                                                                                       .reset(reset),
  ...
  Bilateral_ip_fifo_data u_Bilateral_ip_fifo_data_inst (.clk(clk),
                                                        .reset(reset),
                                                        .enb(enb),
                                                        .In(AXI4_Stream_Video_Slave_TDATA),  // ufix32
                                                        .Push(AXI4_Stream_Video_Slave_TVALID),  // ufix1
                                                        .Pop(fifo_rd_ack),  // ufix1
                                                        .Out(stream_in_fifo_user_data),  // ufix32
...
endmodule  // Bilateral_ip_axi4_stream_video_slave
