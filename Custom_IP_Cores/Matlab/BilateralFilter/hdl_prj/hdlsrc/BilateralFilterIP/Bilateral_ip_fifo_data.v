// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\BilateralFilterIP\Bilateral_ip_fifo_data.v
...
// -------------------------------------------------------------
// 
// Module: Bilateral_ip_fifo_data
// Source Path: Bilateral_ip/Bilateral_ip_axi4_stream_video_slave/Bilateral_ip_fifo_data
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Bilateral_ip_fifo_data
  ...
  Bilateral_ip_SimpleDualPortRAM_generic #(.AddrWidth(2),
                                         ...
                                         u_Bilateral_ip_fifo_data_classic_ram (.clk(clk),
                                                                               .enb(enb),
                                                                               .wr_din(In),
                                                                               .wr_addr(w_waddr),
                                                                               .wr_en(w_we),  // ufix1
...
endmodule  // Bilateral_ip_fifo_data
